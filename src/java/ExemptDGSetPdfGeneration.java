...
public class ExemptDGSetPdfGeneration {
	public File pdfFunction(String indname,String indaddress,String inddistrict,String indtehsil,String indPin,String capacity,
		...
		heading121.add(new Chunk("							The activity of operating DG Sets upto 1 MVA falls under White Category as per revised Guidelines issued by the Committee vide No. SPCB/Estb/Co/Gen./ICC/ 91/1253-61 dated :- 29/04/2016",
				new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE -1, Font.NORMAL)));
		...
		cell11 = new PdfPCell (new Paragraph (new Chunk("The White / Exemption Certificate is being issued to operate the D.G. Set of Capacity "+ capacity +" KVA, subject to the following conditions:-", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE -1, Font.NORMAL,new Color(0,0,0)))));
		...
		cell11 = new PdfPCell (new Paragraph (new Chunk("The owner of the DG Set shall maintain cleanliness and good housekeeping all around the premises.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE -1, Font.NORMAL,new Color(0,0,0)))));
		//cell11.setHorizontalAlignment (Element.ALIGN_LEFT);
		cell11.setPadding (3.0f);
		cell11.setBorder(PdfPCell.NO_BORDER);
		cell11.setHorizontalAlignment(Element.ALIGN_JUSTIFIED);
		...
		cell11 = new PdfPCell (new Paragraph (new Chunk("There shall be no perspective noise and smoke in surrounding by the operation of DG Set.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE -1, Font.NORMAL,new Color(0,0,0)))));
		//cell11.setHorizontalAlignment (Element.ALIGN_LEFT);
		cell11.setPadding (3.0f);
		cell11.setBorder(PdfPCell.NO_BORDER);
		cell11.setHorizontalAlignment(Element.ALIGN_JUSTIFIED);
		...
		cell11 = new PdfPCell (new Paragraph (new Chunk("The owner of the DG shall abide by the direction of the Committee issued from time to time. Any infringement / violation or transgression of the statutory enactments of pollution Control Acts by the unit holder shall be sufficient cause to prosecute the violator in conformity with the relevant sections under Environmental laws.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE -1, Font.NORMAL,new Color(0,0,0)))));
		//cell11.setHorizontalAlignment (Element.ALIGN_LEFT);
		cell11.setPadding (3.0f);
		cell11.setBorder(PdfPCell.NO_BORDER);
		cell11.setHorizontalAlignment(Element.ALIGN_JUSTIFIED);
		...
		cell11 = new PdfPCell (new Paragraph (new Chunk("The DG Set shall be under surveillance and monitoring of J&K SPCB.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE -1, Font.NORMAL,new Color(0,0,0)))));
		//cell11.setHorizontalAlignment (Element.ALIGN_LEFT);
		cell11.setPadding (3.0f);
		cell11.setBorder(PdfPCell.NO_BORDER);
		cell11.setHorizontalAlignment(Element.ALIGN_JUSTIFIED);
		...
		cell11 = new PdfPCell (new Paragraph (new Chunk("Waste material generated from the D.G. Set Batteries should be treated in scientific manner.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE -1, Font.NORMAL,new Color(0,0,0)))));
		//cell11.setHorizontalAlignment (Element.ALIGN_LEFT);
		cell11.setPadding (3.0f);
		cell11.setBorder(PdfPCell.NO_BORDER);
		cell11.setHorizontalAlignment(Element.ALIGN_JUSTIFIED);
		...
		paraP48.add(new Chunk("Copy to the :" +
				...
				"\n		2. Divisional Officer SPCB "+ divisionalofficer +" for information & necessary action." +
				"\n		3. Office File.",
				new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE -1, Font.NORMAL)));
