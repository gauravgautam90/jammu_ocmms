...
public class BioMedicalWasteRenewCertificate{
	...
	String catinst,String noOfchairs,String noOfbeds,String occName,String offAddres,
			String addrPlaceDisposalOfWaste,String termsco, String draftLetterDate,
			 ...
			 String renewTo,String officername,Boolean generation,Boolean collection,Boolean storage,Boolean transportation,Boolean reception,
				...
				String collected,String authCancelled) throws Exception {
	...
	Image image = Image.getInstance("images2/JHK_Logo.jpg");
				...
				//	}else{
					...
					headinginfo.add(new Chunk("Jammau/Kashmir" ,new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.NORMAL,new Color(0, 0, 0))));
...
public File bioCertRenew(String draftLetterFor, ArrayList catList,String industryName,String industryAddress,String industryTehsil,
		String industryDistrict,String nameOfDistrict,String authorizationNumber,String letternumber,
		String noticeDate,String[] copyTo,ArrayList chk,String authPer, String noOfBeds,
		String noOfsamples,String noOfSamples,String noOfpatients,String noOfPatients,
		String expiryDate,String activityauthorizationsoughtfor, String subject,String appDate, 
	...
	PdfWriter.getInstance(document,
			...
			Phrase footerPhrase = new Phrase ("                      Keep Harayana Clean & Green",new Font(
					Font.TIMES_ROMAN, Font.DEFAULTSIZE-2));
			HeaderFooter footer = new HeaderFooter(footerPhrase, true);
			footer.setAlignment(Element.ALIGN_CENTER);
			document.setFooter(footer);
...
//if(typeOfInd.equals("bmw")){
		...
		//	}else{
			...
			headinginfo.add(new Chunk("Jammu/Kasmir" ,  new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.NORMAL,new Color(0, 0, 0))));
		...
		//	headinginfo.add(new Chunk("                                                  S.C.O. 180,IInd Floor,Sector 5,Panchkula(Hry)" ,  new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.NORMAL,new Color(0, 0, 0))));
			...
			int year1 = year+1;
				headinginfo2.add(new Chunk("                No.:JKSPCB/BMW/"+year+"-"+(year1)+"                                              Dated: " +draftLetterDate,  new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.BOLD,new Color(0, 0, 0))));
...
//																		float[] columnWidths12 = { 0.50f,10f };
//																		table12.setWidths(columnWidths12);
//																		table12.setWidthPercentage(100);
//																		table12.setHorizontalAlignment(30);
//																		
//																		PdfPCell cell21 = new PdfPCell();
//																		
//																		cell21 = new PdfPCell (new Paragraph (new Chunk("															",  new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE - 1,Font.BOLD))));
...
//																		
//																		cell21 = new PdfPCell (new Paragraph (new Chunk("																General Deficiencies :",  new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE - 1,Font.BOLD))));
//																		cell21.setHorizontalAlignment (Element.ALIGN_LEFT);
//																		cell21.setColspan(2);
//																		cell21.setVerticalAlignment(Element.ALIGN_LEFT);
//																		cell21.setPadding (5.0f);
...
//
//																		
//																		for(int var2=0;var2<conditionDetailsList.size();var2++)
//																		{
//																			ArrayList al=(ArrayList) conditionDetailsList.get(var2);
//																			
...
//																				cell21 = new PdfPCell (new Paragraph("																"+a,new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE - 1,Font.BOLD)));
//																				//cell21.setColspan(2);
//																				cell21.setHorizontalAlignment (Element.ALIGN_LEFT);
//																				//cell.setBackgroundColor (new Color (128, 200, 128));
//																				cell21.setPadding (5.0f);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("A pit or trench should be dug about 2m. deep.It should be half filled with waste than covered with the lime with waste than covered with lime within 50cm.of the surface before\nfilling the rest of the pit with soil.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("It must be ensure that animal do not have access to burial sites.Cover of galvanized iron/wire meshes may be used", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("On each occasion when waste are added to the pit,a layer of 10 cm. of soil shall be added to cover the wastes", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("Burials must be performed under close and dedicated supervision", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("The deep burial site should be relatively impremeable no shallow well close to site", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("The pits shoulds be distant from habitation and site so as ensure that no contemination occurs of any surface water or ground water.The\narea should not the pits should be prone to flooding or erossions", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//														
//												//21 row
//														cell3 = new PdfPCell (new Paragraph (new Chunk("21.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE  , Font.BOLD,new Color(0,0,0)))));
//														//cell3.setColspan (2);
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color(0, 0, 0));
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("The location of deep burial site will be authorised by the prescribed authority.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//														
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("22.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE  , Font.BOLD,new Color(0,0,0)))));
//														//cell3.setColspan (2);
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color(0, 0, 0));
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("The institution shall maintain a record of all pits for deep burial", new Font(Font.TIMES_ROMAN ,Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//														
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("23.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE  , Font.BOLD,new Color(0,0,0)))));
//														//cell3.setColspan (2);
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color(0, 0, 0));
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("Occupier will install incienarator/APCM such as wet scrubber of its own or having facility within 2months & will submit scheme along\nwith the time phased programme within 15 days", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//														
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("24.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE  , Font.BOLD,new Color(0,0,0)))));
//														//cell3.setColspan (2);
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color(0, 0, 0));
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//
//														
//														cell3 = new PdfPCell (new Paragraph (new Chunk("Occupier will submit analysis report after the installation of incinerator/APCM", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
//														cell3.setHorizontalAlignment (Element.ALIGN_LEFT);
//														//cell3.setBackgroundColor (new Color (255, 200, 0));
//														cell3.setPadding (1.0f);
//														cell3.setVerticalAlignment(Element.ALIGN_CENTER);
...
//														
//														
//														cell1 = new PdfPCell (new Paragraph (new Chunk("Endst.No.HSPCB/BMW.", new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE  , Font.BOLD,new Color(0,0,0)))));
//														//cell1.setColspan (2);
//														cell1.setHorizontalAlignment (Element.ALIGN_LEFT);
...
//
//														
//														cell1 = new PdfPCell (new Paragraph (new Chunk("Dated: "+draftLetterDate, new Font(Font.TIMES_ROMAN , Font.DEFAULTSIZE , Font.BOLD,new Color(0, 0, 0)))));
...
//														
//														
//														 Paragraph  bottom1 = new Paragraph();
//															
//															bottom1.add(new Chunk("                                  Copy forwarded to chairman,Haryana State Pollution Control Committee Panchkula for information please." ,  new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.BOLD,new Color(0, 0, 0))));
//															//bottom.setAlignment(Element.ALIGN_RIGHT);
//
