...
public class RevokeWaterHwmPdfGeneration {




	public File waterHwmPdfFunction(String grpName,String desination,String industryId,String occupierName, String address,String indName,String appId,String fileNo,String details,String employeeName,String employeeName1,String createOn,String certFor,String consentFrom,String consentTo,String grpByRoOfficeAddress)throws Exception
			{
     ...
     // For Image
	  ...
	  //For New Heading
		...
		heading5.add(new Chunk("Subject: Revocation of grant of Consent to Operate under Water Act, 1974 and Authorization under Hazardous & Other Waste (Management, Handling and Transboundary Movement) Rules,2016.", new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE + 0, Font.NORMAL,new Color(0,0,0))));
		...
		heading611.add(new Chunk("					A Show Cause notice for revocation of grant of CTO under Water Act, 1974 and Authorization under Hazardous & Other Waste (Management, Handling and Transboundary Movement) Rules,2016 was issued to unit vide letter no "+fileNo+
