...
public class MunicipalSolidCertReNew {

	public File municipalCertRenew(String industryPhone,String industryName,String industryAddress,String industryTehsil,String industryDistrict,String authorizationNumber,String letternumber,String noticeDate,String terms,String copyTo,String id) throws Exception {
		...
		sub.add(new Chunk("Renewal of Authorization under rule 6 (3) of the Municipal soild wastes (Management and Handling) Rules 2000. ",
