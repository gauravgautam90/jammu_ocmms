...
public class RevokeAirHwmPdfGeneration {




	public File airHwmPdfFunction(String grpName,String desination,String industryId,String occupierName, String address,String indName,String appId,String fileNo,String details,String employeeName,String employeeName1,String createOn,String certFor,String consentFrom,String consentTo,String grpByRoOfficeAddress)throws Exception
			{
     ...
     // For Image
	  ...
	  //For New Heading
		...
		heading5.add(new Chunk("Subject: Revocation of grant of Consent to Operate under Air Act, 1981 and Authorization under Hazardous & Other Waste (Management, Handling and Transboundary Movement) Rules, 2016.", new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE + 0, Font.NORMAL,new Color(0,0,0))));
		...
		heading6.add(new Chunk("		Please refer to the subject noted above" +
				"\n			The Regional officer <Region name> has intimated that the above said unit is violating on following grounds:-", new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE + 0, Font.NORMAL,new Color(0,0,0))));
		...
		heading611.add(new Chunk("					A Show Cause notice for revocation of grant of CTO under Air Act, 1981 and Authorization under Hazardous & Other Waste (Management, Handling and Transboundary Movement) Rules, 2016 was issued to unit vide letter no "+fileNo+
		...
		heading6112.add(new Chunk("Therefore, in view of above, Consent to Operate and Authorization granted to you by board vide letter no "+appId+""+createOn+" for period from " +
