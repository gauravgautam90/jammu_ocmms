...
public class InspectionreportIns 
{
...
ArrayList HotelGeneralDetailsInspectionList,String resArea,String spmLevel,ArrayList HazardousWasteGenDetailsList,String indType,String regNo
	...
	throws Exception {
		...
		try{
		 ...
		 System.out.println("--Inside in pdf 3---");
				...
				cellz = new PdfPCell (new Paragraph (new Chunk("PCC|"+number, new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.NORMAL ,new Color(0, 0, 0) ))));
				cellz.setHorizontalAlignment (Element.ALIGN_LEFT);
				//cellz.setBorder(PdfPCell.NO_BORDER);
				tablez.addCell (cellz);
			...
			//	cellz.setBorder(PdfPCell.NO_BORDER);
				...
				cellz = new PdfPCell (new Paragraph (new Chunk("Classification Approved by the Board", new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.BOLD ,new Color(0, 0, 0) ))));
				cellz.setHorizontalAlignment (Element.ALIGN_LEFT);
				//cellz.setColspan(2);
				//cellz.setBorder(PdfPCell.NO_BORDER);
				tablez.addCell (cellz);
	...
	tablez.addCell (cellz);
			...
			tablez.addCell (cellz);
				...
				if(deeRecommendationsListbb.size()!=0){
...
if((applicationFor.equals("brickkilns")) && (!indType.equals("Hot mix plants"))){
				...
				cellz0 = new PdfPCell (new Paragraph (new Chunk("(a) Category of unit as per general classification approved  by the board", new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.BOLD ,new Color(0, 0, 0) ))));
				cellz0.setHorizontalAlignment (Element.ALIGN_LEFT);
				//cellz0.setBorder(PdfPCell.NO_BORDER);
				table0.addCell (cellz0);
			...
			if((applicationFor.equals("hotel")) && (!indType.equals("Hot mix plants"))){
				...
				cellzz111 = new PdfPCell (new Paragraph (new Chunk("PCC|"+number, new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.NORMAL ,new Color(0, 0, 0) ))));
				cellzz111.setHorizontalAlignment (Element.ALIGN_LEFT);
				//cellzz111.setBorder(PdfPCell.NO_BORDER);
				tablezz111.addCell (cellzz111);
			...
			if((applicationFor.equals("dgset")) && (!indType.equals("Hot mix plants"))){
						...
						cellz33 = new PdfPCell (new Paragraph (new Chunk("PCC|"+number, new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.NORMAL ,new Color(0, 0, 0) ))));
						cellz33.setHorizontalAlignment (Element.ALIGN_LEFT);
						cellz33.setBorder(PdfPCell.NO_BORDER);
						table33.addCell (cellz33);
			...
			cellz0 = new PdfPCell (new Paragraph (new Chunk("(b) Category of unit as per general classification approved  by the board", new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.BOLD ,new Color(0, 0, 0) ))));
			cellz0.setHorizontalAlignment (Element.ALIGN_LEFT);
			cellz0.setBorder(PdfPCell.NO_BORDER);
			table0.addCell (cellz0);
