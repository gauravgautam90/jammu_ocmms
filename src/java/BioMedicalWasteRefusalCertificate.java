...
public class BioMedicalWasteRefusalCertificate {

	public File bioCertRefusal(String draftLetterFor, ArrayList catListDetails,
			String industryName, String industryAddress, String industryTehsil,
			String industryDistrict, String nameOfDistrict,
			String authorizationNumber, String letternumber, String noticeDate,
			String copyTo, ArrayList chk, String authPer, String noOfBeds,
			String noOfsamples, String noOfSamples, String noOfpatients,
			String noOfPatients, String expiryDate,
			String activityauthorizationsoughtfor, String subject,
			String appDate, String catinst, String noOfchairs, String noOfbeds,
			String occName, String offAddres, String addrPlaceDisposalOfWaste,
			String termsco, String draftLetterDate, String reference,
			String roleName1, String appId, String dateofsubmition,
			String name, String nameind, String address, String date,
			String offname, String offdesg, String renewFrom, String renewTo,
			String officername, Boolean generation, Boolean collection,
			Boolean storage, Boolean transportation, Boolean reception,
			Boolean reuse, Boolean recycling, Boolean recovery,
			Boolean preprocessing, Boolean coprocessing, Boolean treatment,
			Boolean disposal, Boolean incineration, Boolean utilisation,
			String facility, String serviceProvider, String collected,
			String authCancelled) throws Exception {

		{
			...
			cell1 = new PdfPCell(new Paragraph(new Chunk("Dated :  "
					+ date, new Font(Font.TIMES_ROMAN,
			...
			cell1a = new PdfPCell(
					new Paragraph(
							new Chunk(
									"Rejection of your application for Authorization under the Bio-Medical Waste Management Rules, 2016- regarding.",
			...
			subHeading1cc
					.add(new Chunk(
							"                      Whereas, you have applied for grant of Authorization under the Bio-Medical Waste Management Rules, 2016 vide your application no. "
									+ appId + " dated " + appDate + ".",
			...
			cell1b = new PdfPCell(new Paragraph(new Chunk(""
					+ termsco, new Font(Font.TIMES_ROMAN,
					Font.DEFAULTSIZE - 1, Font.NORMAL))));
			...
			new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE - 1, Font.BOLD)));
			subHeading1h.add(new Chunk("" + copyTo,
