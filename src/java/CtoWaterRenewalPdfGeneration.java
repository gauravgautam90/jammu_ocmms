...
public class CtoWaterRenewalPdfGeneration {
	...
	public File pdfFunction(String endtNumberIn,String dateFrom, String dateTo,String productD,String productQ,String certData,String fileNum,String offDistrict,String draftDate,String officeAddress,String reference,
		...
		subj.add(new Chunk("Sub:", new Font(Font.TIMES_ROMAN,
				Font.DEFAULTSIZE + 3, Font.BOLD)));
		subj.add(new Chunk("Renewal of consent Under Section 25/26 of the Water (Prevention and Control of Pollution) Act,1974.", new Font(Font.TIMES_ROMAN,
				Font.DEFAULTSIZE + 1)));
		// p.add(new Chunk("something3", new Font(Font.TIMES_ROMAN,
		// Font.DEFAULTSIZE + 2, Font.BOLD)));
		...
		lastSign.add(new Chunk("J & K State Pollution Control Committee",
				new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE + 1, Font.BOLD)));
		...
		Paragraph copYtoo1 = new Paragraph("1. Regional Officer,Regional Office,J & K Pollution Control Committee, "+offDistrict+" .Please ensure compliance and report if any condition/conditions are violated by the industry.");
...
Paragraph copYtoo2 = new Paragraph("2. Cess Section, J & K Pollution Control Committee");

		
		copYtoo2.setIndentationLeft(20);
		copYtoo2.setAlignment(Element.ALIGN_JUSTIFIED);
		// p.add(new Chunk("something3", new Font(Font.TIMES_ROMAN,
		// Font.DEFAULTSIZE + 2, Font.BOLD)));
		document.add(copYtoo2);
