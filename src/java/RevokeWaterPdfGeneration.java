...
public class RevokeWaterPdfGeneration {



	public File waterPdfFunction(String grpName,String desination,String industryId,String occupierName, String address,String indName,String appId,String fileNo,String details,String employeeName,String employeeName1,String createOn,String certFor,String consentFrom,String consentTo,String grpByRoOfficeAddress)throws Exception
			{
     ...
     // For Image
	  ...
	  //For New Heading
		...
		heading5.add(new Chunk("Subject: Revocation of Consent to Operate granted under Water Act, 1974.", new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE + 0, Font.NORMAL,new Color(0,0,0))));
		...
		heading611.add(new Chunk("					A Show Cause notice for revocation of CTO granted under Water Act, 1974 was issued to unit vide letter no "+fileNo+
