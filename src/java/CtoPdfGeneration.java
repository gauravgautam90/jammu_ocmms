...
public class CtoPdfGeneration {
	public File pdfFunction(String endtNumberIn,String productD,String productQ,String certData,String fileNum,String offDistrict,String draftDate,String officeAddress,String reference,
		...
		subj.add(new Chunk("Sub:", new Font(Font.TIMES_ROMAN,
				Font.DEFAULTSIZE + 3, Font.BOLD)));
		subj.add(new Chunk("Grant of consent under section 21 of the Air (Prevention and Control of Pollution) Act, 1981.", new Font(Font.TIMES_ROMAN,
				Font.DEFAULTSIZE + 1)));
		// p.add(new Chunk("something3", new Font(Font.TIMES_ROMAN,
		// Font.DEFAULTSIZE + 2, Font.BOLD)));
	...
	public File pdfFunctionArray(String productD,String productQ,String certData,String fileNum,String offDistrict,String draftDate,String officeAddress,String[] referencearray,
			 String name, String address1, String tehsilName,
			String districtName,
			   String gCondition,
			String sCondition,String copyTo) throws Exception {
		...
		Paragraph heading = new Paragraph();
		heading.add(new Chunk("J & K Pollution Control Committee",new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE + 4, Font.BOLD)));
		heading.setAlignment(Element.ALIGN_CENTER);
...
document.add(space9);
		...
		Paragraph lastSign = new Paragraph();
		lastSign.add(new Chunk("J & K Pollution Control Committee",			new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE + 1, Font.BOLD)));
		lastSign.setAlignment(Element.ALIGN_RIGHT);
		document.add(lastSign);
		...
		videNo1.add(new Chunk("Endt No :", new Font(Font.TIMES_ROMAN,
				Font.DEFAULTSIZE + 1, Font.BOLD)));
		videNo1.add(new Chunk("  " +fileNum, new Font(
				Font.TIMES_ROMAN, Font.DEFAULTSIZE + 3, Font.BOLD)));
		videNo1.add(new Chunk("           ", new Font(Font.TIMES_ROMAN,
				Font.DEFAULTSIZE + 3, Font.BOLD)));
		videNo1.add(new Chunk("           ", new Font(Font.TIMES_ROMAN,
