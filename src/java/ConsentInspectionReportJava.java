...
public class ConsentInspectionReportJava {
...
ArrayList HotelGeneralDetailsInspectionList,String resArea,String spmLevel,ArrayList HazardousWasteGenDetailsList,String indType,String regNo,String district,String email
	)	throws Exception {
		File tempFile = new File("Inspection Report.pdf");
		try{
			
		       System.out.println("---Inside in pdf 2---");
				...
				cellz = new PdfPCell (new Paragraph (new Chunk(" "+indName+"\n District: "+district+"\n Email:"+email, new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.NORMAL ,new Color(0, 0, 0) ))));
				cellz.setHorizontalAlignment (Element.ALIGN_LEFT);
				//cellz.setBorder(PdfPCell.NO_BORDER);
				tablez.addCell (cellz);
...
if((applicationFor.equals("brickkilns")) && (!indType.equals("Hot mix plants"))){
				...
				cellz0 = new PdfPCell (new Paragraph (new Chunk("Name: "+indName+"\n District: "+district+"\n Email: "+email, new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.NORMAL ,new Color(0, 0, 0) ))));
				cellz0.setHorizontalAlignment (Element.ALIGN_LEFT);
				//cellz0.setBorder(PdfPCell.NO_BORDER);
				table0.addCell (cellz0);
			...
			if((applicationFor.equals("hotel")) && (!indType.equals("Hot mix plants"))){
				...
				cellzz111 = new PdfPCell (new Paragraph (new Chunk(" "+indName+"\n District: "+district+"\n Email: "+email, new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE,Font.NORMAL ,new Color(0, 0, 0) ))));
				cellzz111.setHorizontalAlignment (Element.ALIGN_LEFT);
				//cellzz111.setBorder(PdfPCell.NO_BORDER);
				tablezz111.addCell (cellzz111);
