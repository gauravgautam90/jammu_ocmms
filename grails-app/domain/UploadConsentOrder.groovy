 ...
 *
 */
public class UploadConsentOrder{
	...
	Boolean  specialCharCheck(String field)
	{
	    ...
	    //	generalCondition(validator: {indnm,obj->return  obj.specialCharCheck(indnm)})
		//	specificCondition(validator: {indnm,obj->return  obj.specialCharCheck(indnm)})
		//	subjectData(validator: {indnm,obj->return  obj.specialCharCheck(indnm)})
		//	subjectData(validator: {indnm,obj->return  obj.specialCharCheck(indnm)})
