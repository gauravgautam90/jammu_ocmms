...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="225" valign="top" bgcolor="#E6E7E4"><div class="lft-bg">
        ...
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link action="" >Add </g:link></div>
      </div>
      <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link action="" >Update</g:link></div>
      </div>
    ...
    <td width="100%" valign="top" bgcolor="#FFFFFF" ><div class="path-bg">&nbsp;</div>
      ...
      <g:if test="${flash.message}">
            <div class="message">${flash.message}</div>
                ...
                <g:form name="form1" id="form1" method="post" controller="indCatMaster" action="xyz">
...
<td width="100%" align="center">
    <div >
        ...
        <tr align="left">
          <td colspan="2" ><table width="160" border="0" cellspacing="0" cellpadding="0">
                          <tr >
                            ...
                            <td bgcolor="#5A89D9" class="headng1" width="134">Forget Password</td>
                      ...
                      <tr align="left">
                       ...
                       <tr bgcolor="#F4F7FB">
                       <td  align="left" valign="middle" class="headngblue"> 
                   ...
                   <tr align="center" >
                              <td width="150px" align="left" valign="middle" class="headngblue">Enter UserName* :</td>
                        <td align="left" class="headngblue1">
                                    <input type="text" id="userName" name="userName" value="" class="txt4">
                                </td>
                        </div></td>
                      </tr>
					  <tr><td align="center" width=""><a href="#" onclick="return validateForm();"><b>Click Here</b></a></td></tr>
	  ...
	  <div align="center" >
<!--<g:actionSubmit class="headngblue" value="submit" action="abc" style="width: 120px;
