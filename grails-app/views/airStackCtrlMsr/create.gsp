  ...
  <tr>
   ...
   <div class="lft-lnks"><img  src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><a href="#">Create </a></div>
    ...
    <g:if test="${flash.message}">
            ...
            <g:hasErrors bean="${airStackCtrlMsrInstance}">
            <div class="errors">
                <g:renderErrors bean="${airStackCtrlMsrInstance}" as="list" />
            </div>
            </g:hasErrors>
...
<td width="100%" align="center">
    <div >
        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0" cellspacing="0" cellpadding="0">
                          <tr >
                            ...
                            <td bgcolor="#5A89D9" class="headng1" width="134">Create </td>
                      ...
                      <tr align="center">
                        ...
                        <td align="left"><span class="txt style6">
						 <g:select optionKey="id" from="${AirEmmisionType.list()}" name="typeId.id" value="${airStackCtrlMsrInstance?.typeId?.id}" ></g:select>
                      ...
                      <tr bgcolor="#F4F7FB">
                       ...
                       <td ><div align="left">
                         <input type="text" id="airEmType" name="airEmType" value="${fieldValue(bean:airStackCtrlMsrInstance,field:'airEmType')}"/>
                        </div></td>
                      </tr>
	  ...
	  <div align="center">
	  <input type="submit" value="Save Record" style="width: 120px;
