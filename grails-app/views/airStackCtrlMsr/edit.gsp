...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="225" valign="top" bgcolor="#E6E7E4"><div class="lft-bg">
       <div class="lft-lnks"><img  src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><a href="#">Create Role</a></div>
      </div>
      <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link action="UP" >Update Role</g:link></div>
      </div>
      <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link action="del" >Delete Role</g:link></div>
      </div>
      <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><a href="#">Attach Officers To Role</a></div>
      </div>
    ...
    <td width="100%" valign="top" bgcolor="#FFFFFF" ><div class="path-bg">&nbsp;</div>
     ...
     <g:if test="${flash.message}">
            ...
            <g:form action="update" method="post" >
				  <input type="hidden" name="id" value="${airStackCtrlMsrInstance?.id}" />
                <input type="hidden" name="version" value="${airStackCtrlMsrInstance?.version}" />
    <table align="center">
<tr align="center">
<td width="100%" align="center">
    <div >
        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0" cellspacing="0" cellpadding="0">
                          <tr >
                            ...
                            <td bgcolor="#5A89D9" class="headng1" width="134">Update Role</td>
                      ...
                      <tr align="center">
                        ...
                        <td width="150px" class="headngblue" ><div align="right" class="style3">Air Em Type:</div></td>
                          ...
                          <td align="left" class="value ${hasErrors(bean:roleMasterInstance,field:'groupId','errors')}">
                            <span class="style1">     ${airStackCtrlMsrInstance?.typeId}
                                </td>
                        </span></td>
                      </tr>
                            <tr align="center" >
                              <td width="150px" align="right" valign="middle" class="headngblue"><div align="right" class="style3">Name:</div></td>
                        <td ><div align="left">
                          
                                    <input type="text" id="name" name="name" value="${fieldValue(bean:airStackCtrlMsrInstance,field:'name')}"/>
                        </div></td>
                      </tr>
                      <tr bgcolor="#F4F7FB">
                        <td  width="150px" class="headngblue"><div align="right" class="style3">AirEm:</div></td>
                       
                          <td  >
                                 <div align="left">   <input type="text" id="airEmType" name="airEmType" value="${fieldValue(bean:airStackCtrlMsrInstance,field:'airEmType')}"/>
                        </div></td>
                      </tr>
	  ...
	  <div align="center">
	  <input type="submit" value="Update Record" style="width: 120px;
