...
document.observe('dom:loaded', function() {
   ...
   $("roleSelected").observe("change", respondToSelectUser);
   });
   
 function respondToSelect(event)
 {
       new Ajax.Updater("roleSelected",
          "/SPCB/roleMaster/updateSelectRoleProfile",
          {method:'get', parameters: {selectedValue : $F("grpSelected")} }
         );
 }
 
 function respondToSelectUser(event)
 {
       new Ajax.Updater("OfficerSelected",
          "/SPCB/ro/updateGrpSel",
          {method:'get', parameters: {selectedValue : $F("roleSelected")} }
         );
 }
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="225" valign="top" bgcolor="#E6E7E4"><div class="lft-bg">
        <div class="lft-lnks"><img  src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link controller="roleMaster" action="gotoCreate" >Create Role</g:link></div>
      </div>
      <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link controller="roleMaster" action="UP" >Update Role</g:link></div>
      </div>
      <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link controller="roleMaster" action="del" >Delete Role</g:link></div>
      </div>
      <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link controller="roleProfileAssignment" action="goToAttach" >Attach Officers To Role</g:link></div>
      </div>
       <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link controller="roleProfileAssignment" action="updateAttach" >Update Officers To Role</g:link></div>
      </div>
...
<td width="100%" align="center">
    <div >
      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bordercolor="#990000">
        ...
        <tr align="left">
          <td colspan="2" ><table width="150" border="0s" cellspacing="0" cellpadding="0">
                          <tr >
                            <td width="12" bgcolor="#5A89D9"><img  src="${createLinkTo(dir:'images',file:'BlueTab_Left.jpg')}" width="10" height="20"></td>
                            <td bgcolor="#5A89D9" class="headng1" width="134">Update Officer</td>
                   ...
                   <g:select optionKey="id" from="${GroupMaster.list()}" id="grpSelected" name="groupId" noSelection="${['xyz':'Not Selected']}" value=""></g:select>
                            ...
                            <tr >
                        <td width="150px" class="headngblue" ><div align="right" class="style3">Role :</div></td>
                        <td align="left"><span class="txt style6">
                        
                         <div id ="roleSelected">
				
				<g:select optionKey="id"  name="grp" id ="roleSelected" from="${myArrayList}"></g:select>
...
background: url('${createLinkTo(dir:'gifs',file:'button.gif')}')  no-repeat  " /></div>
   ...
   <tr>
    <td height="0" colspan="2" bgcolor="#d0d1d0"></td>
  </tr>
  <tr>
