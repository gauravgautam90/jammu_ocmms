    ...
    <td width="100%" valign="top" bgcolor="#FFFFFF" ><div class="path-bg">&nbsp;</div>
      ...
      <g:if test="${flash.message}">
            ...
            <div class="errors">
                ...
                <input type="hidden" name="version" value="${roleProfileAssignmentInstance?.version}" />
    <table align="center">
<tr align="center">
<td width="100%" align="center">
    <div >
      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bordercolor="#990000">
        ...
        <tr align="left">
          <td colspan="2" ><table width="130" border="0s" cellspacing="0" cellpadding="0">
                          <tr >
                      ...
                      <tr align="center">
                        ...
                        <td align="left"><span class="txt style6">
                         ...
                         <div id ="roleSelected" class="style1">
						 ${roleProfileAssignmentInstance?.role}
                  ...
                  <g:select optionKey="id" from="${UserProfile.list()}" name="primaryEmployee.id" value="${roleProfileAssignmentInstance?.primaryEmployee?.id}" ></g:select>       
                   ...
                   <g:select optionKey="id" from="${UserProfile.list()}" name="linkEmployee.id" value="${roleProfileAssignmentInstance?.linkEmployee?.id}" ></g:select>
