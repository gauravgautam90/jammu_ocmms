...
<td width="100%" align="center">
          ...
          <td colspan="2" ><table width="110" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr align="center">
                        ...
                        <td width="150px" class="headngblue" ><div align="right" class="style3">District* :</div></td>
                          ...
                          <td align="left"  class="">
                                    <g:select optionKey="id" from="${DistrictMaster.list()}" name="district.id" onclick="${remoteFunction(controller:'tehsilMaster', action:'myAjax2',update:'teh', params:'\'cont=\' + this.value' )}" value="${tehsilMasterInstance?.district?.id}" ></g:select>
                                </td>
                            
                      </tr>
                            <tr align="center" class="headngblue1" >
                              <td width="150px" align="right"  class="headngblue"> Tehsil :</td>
                        <td align="left" class="value ${hasErrors(bean:tehsilMasterInstance,field:'tehsil','errors')}"><div id="teh">
	<g:select optionKey="id" from="${TehsilMaster.list()}" name="tehsilName.id"  value="${tehsilMasterInstance?.tehsilName?.id}" ></g:select></div>
	</td>
 ...
 <g:actionSubmit  value="go" action="go" class="headngblue" style="width: 120px;
