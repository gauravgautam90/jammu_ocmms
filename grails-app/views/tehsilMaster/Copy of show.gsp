    ...
    <div >
        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0" cellspacing="0" cellpadding="0">
                          <tr >
                            ...
                            <td bgcolor="#5A89D9" class="headng1" width="134">Add Tehsil</td>
                      ...
                      <tr align="center">
                        ...
                        <td width="150px" class="headngblue" ><div align="right" class="style3">District* :</div></td>
                          ...
                          <td align="left"  class="value ${hasErrors(bean:tehsilMasterInstance,field:'district','errors')} headngblue1">
                                    ${fieldValue(bean:tehsilMasterInstance, field:'district')}
                                </td>
                            ...
                            <tr align="center" >
                              <td width="150px" align="right" valign="middle" class="headngblue"> Tehsil Name :</td>
                        <td align="left" class="headngblue1">${fieldValue(bean:tehsilMasterInstance, field:'tehsilName')}
                        </td>
                      </tr>
	  ...
	  <div align="center" >
	       ...
	       <g:form>
                    ...
                    <g:actionSubmit class="edit headngblue" value="Edit"  style="width: 120px;
				...
				<g:actionSubmit class="delete headngblue" onclick="return confirm('Are you sure?');" value="Delete" 
					style="width: 120px;
