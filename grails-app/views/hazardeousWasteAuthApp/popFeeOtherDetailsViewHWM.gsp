...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                            <tr>
                              ...
                              <td width="150" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">HWM Fee Details</a></td>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 ...
 <g:each in="${feeDetailsListHWM}" status="i" var="feeDetailsListHWM">
  <tr align="center" >
  <td bgcolor="#E8F6F9"><span class="txt style6">${feeDetailsListHWM.feeFor}
                        </span></td>
  					      <td bgcolor="#E8F6F9"><span class="txt style6">${feeDetailsListHWM.amount}<img src="${createLinkTo(dir:'images',file:'rupeeblue.jpg')}" width="17"/>
                        </span></td>
...
<tr>
    ...
    <td align="center" height="1" colspan="2"  bgcolor="#d0d1d0">
     <g:link action="spcbShowForm" controller="wasteManagementProcessingDetails" params="[docName:'HWM',appliId:appDetId]">
