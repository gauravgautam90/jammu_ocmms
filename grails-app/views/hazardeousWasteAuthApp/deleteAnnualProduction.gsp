...
selectmenu1.onchange=function()
 {    
  ...
  <td><div style="width: 500px;  vertical-align: middle"><span
					...
					<tr>
					<td align="left"> 
					<span class="txt" style="color: navy"></br><b>List of Production during the year (product wise).</b></span>
					<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
                     ...
                     <td width="150px" align="center"  class="txt" > Product Name</td>
  ...
  <td bgcolor="#E8F6F9"><span class="txt style6">${i+1}
                        ...
                        </span><a href="#" onclick="window.open('<%=request.getContextPath()%>/hazardeousWasteAuthApp/deleteAnnualProductionRecord/<%=previousAuthDetailsInst.id%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" class="actionbutton">  <input type="button" value="Delete" class="actionbutton">	</a></td>
