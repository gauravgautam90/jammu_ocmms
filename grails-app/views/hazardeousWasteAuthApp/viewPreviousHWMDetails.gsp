...
selectmenu1.onchange=function()
        ...
        <input name="appId1" type="hidden" value="<%=indAppDetId%>" />  -->
 				...
 				<tr>
					...
					<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
 					<td width="20%" align="center"  class="txt" >Date of Application for HWA</td>
                        <td width="20%" align="center"  class="txt" >HWA Type </td>
 ...
 <g:each in="${previousAuthList}" status="i" var="previousAuthListInst">
  <tr align="center" >
  <td bgcolor="#E8F6F9"><span class="txt style6">${previousAuthListInst.HWApplication_Date}
                        </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${previousAuthListInst.HWAType}
                        </span></td>
                        ...
                        <td bgcolor="#E8F6F9">
                 		...
                 		<g:def var="fooVar" value="${previousAuthListInst.wasteManagementFileId}"/><g:link action="viewAuthorisationAttached" controller="hazardeousWasteAuthApp" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
                 		</g:if>
                        </span></td>
