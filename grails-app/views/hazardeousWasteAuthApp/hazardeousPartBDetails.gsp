...
<body>
        <g:form name="myForm" method="post" action="saveHazardeousPartBDetails" >
              ...
              <tr>
                   <td>
		                <table width="100%"   border="1" bordercolor="black" align="left" cellpadding="2" cellspacing="0" class="">
             				<tr bgcolor="#D1D1D1">
            					<td colspan="11"  align="center" valign="middle"  class="headngblue">Part B. To be filled by Treatment, storage and disposal facility operators</td>
			            	</tr>
				               ...
				               <table width="100%" border="1" cellpadding="2" cellspacing="0" class="">
						          ...
						          <!--      <td>Unit</td>
						            ...
						            <tr bgcolor="#CCC" style="height: 20px;">
						                ...
						                <td>Total quantity  <br> received<span style="color:red">*</span></td>
						                <td ><input type="number" name="totalQuantity" id="totalQuantity" ></td>
						                
						                <td>Quantity treated<span style="color:red">*</span> </td>
						                <td ><input type="number" name="dispatchedQuantityToDisposalFacility" id="dispatchedQuantityToDisposalFacility" ></td>
						                <td>Quantity disposed  <br>in landfills as such <br> and after treatment <span style="color:red">*</span></td>
						                <td ><input type="number" name="dispatchedQuantityToRecycler" id="dispatchedQuantityToRecycler" ></td>
						                </tr>
						                <tr bgcolor="#CCC" style="height: 20px;">
						                <td>Quantity incinerated <br>(If applicable)<span style="color:red">*</span></td>
						                <td ><input type="number" name="dispatchedQuantityToOthers" id="dispatchedQuantityToOthers" ></td>
						                
						                <td>Quantity processed other<br> than specified above<span style="color:red">*</span></td>
...
if(x3==""){
alert("Please Enter Total quantity received")
		;
...
if(x4==""){
alert("Please Enter Quantity treated");
...
if(x5==""){
alert("Quantity disposed in landfills as such and after treatment");
...
if(x6==""){
alert("Please Enter Quantity incinerated If applicable");
document.getElementById("dispatchedQuantityToOthers").focus();
 return false;
  }
var x7 = document.getElementById("utilisedQuantityInHouse").value;
if(x7==""){
alert("Please Enter Quantity processed other than specified above");
...
document.getElementById("UnitId").value="Number";
    ...
    <table border="1" width="95%" align="center" cellpadding="0"	cellspacing="0" class="tblbdr" bordercolor="black">
			 ...
			 <tr bgcolor="#CCC" >
                ...
                <td width="25%" align="center" class="headngblue">Total quantity received </td>
                <td width="10%" align="center" class="headngblue">Quantity treated</td>
                <td width="10%" align="center" class="headngblue">Quantity disposed in <br>landfills as such and<br> after treatment </td>
                <td width="10%" align="center" class="headngblue">Quantity incinerated (If applicable)</td>
                <td width="10%" align="center" class="headngblue">Quantity processed other<br> than specified above</td>
