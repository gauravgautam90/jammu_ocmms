 ...
 <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        <td width="20%" align="center"  class="txt" >DD No./Cheque No.</td>
							  ...
							  <td width="150px" align="center" class="txt">Branch Name/Address</td>
 ...
 <g:each in="${feeDetailsList}" status="i" var="feeDetailsListInst">
  <tr align="center" >
  					<td bgcolor="#E8F6F9"><span class="txt style6">${feeDetailsListInst.ddChequeNo}
                        ...
                        <td bgcolor="#E8F6F9"><span class="txt style6">${feeDetailsListInst.amount}
 					...
 					<td class="txt style6" align="left" colspan="3"><%if(feeCheque){%>	<g:def var="fooVar" value="${appDetId}"/><g:link action="viewChequeAttached" controller="hazardeousWasteAuthApp" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
<%}%></td>
 					</tr>
...
<tr>
    ...
    <td align="center" height="1" colspan="2"  bgcolor="#d0d1d0"> <!--  <input type="button" class="actionbutton" name="back" value="Back" onclick="window.open('<%=request.getContextPath()%>/bioMedicalWaste/popPreviousApp/<%=appDetId%>#country2', 'ApplicationHistory', 'WIDTH=800,HEIGHT=450,scrollbars=1,resizable=yes');"> --><input class="actionbutton" type="button" name="close" value="close" onclick="window.close();"/></td>
...
<%
 ...
 <tr>
    ...
    <td align="center" height="1" colspan="2"  bgcolor="#d0d1d0"><!--  <input type="button" class="actionbutton" name="back" value="Back" onclick="window.open('<%=request.getContextPath()%>/wasteManagementProcessingDetails/spcbShowForm?docName=BMW&appliId=<%=appDetId%>#country5', 'ApplicationHistory', 'WIDTH=800,HEIGHT=450,scrollbars=1,resizable=yes');"> -->
    <input class="actionbutton" type="button" name="close" value="close" onclick="window.close();"/></td>
