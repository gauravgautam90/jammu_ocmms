...
<body>
        <g:form name="myForm" method="post" action="saveHazardeousPartCDetails" >
              ...
              <tr>
                   <td>
		                <table width="100%"   border="1" bordercolor="black" align="left" cellpadding="2" cellspacing="0" class="">
             				<tr bgcolor="#D1D1D1">
            					<td colspan="11"  align="center" valign="middle"  class="headngblue">Part C. To be filled by recyclers or co-processors or other users</td>
			            	</tr>
				            ...
				            <tr><td>
				               <table width="100%" border="1" cellpadding="2" cellspacing="0" class="">
						           ...
						           <!--     <td>Unit</td>
						            ...
						            <table width="100%" border="1" cellpadding="2" cellspacing="0" class="">
						            <tr bgcolor="#CCC" style="height: 20px;">
						                <td>Quantity in stock <br>at the beginning<br> of the year <span style="color:red">*</span></td>
						                <td ><input type="number" name="beginningStockQuantity" id="beginningStockQuantity" ></td>
						                
						                <td>Quantity of waste received<br> during the year from <br> Domestic sources<span style="color:red">*</span></td>
						                <td ><input type="number" name="totalQuantity" id="totalQuantity" ></td>
						                
						                <td>Quantity of waste<br> received during<br> the year Imported <span style="color:red">*</span> </td>
						                <td ><input type="number" name="dispatchedQuantityToDisposalFacility" id="dispatchedQuantityToDisposalFacility" ></td>
						               
						                <td>Quantity recycled or<br> co-processed or used<span style="color:red">*</span></td>
						                <td ><input type="number" name="dispatchedQuantityToRecycler" id="dispatchedQuantityToRecycler" ></td>
						                </tr>
						                <tr bgcolor="#CCC" style="height: 20px;">
						                <td>Quantity of waste generated<span style="color:red">*</span></td>
						                <td ><input type="number" name="dispatchedQuantityToOthers" id="dispatchedQuantityToOthers" ></td>
						                
						                <td>Quantity of waste disposed<span style="color:red">*</span></td>
						                <td ><input type="number" name="utilisedQuantityInHouse" id="utilisedQuantityInHouse" ></td>
						                
						                <td>Quantity re-exported<br> (wherever applicable) <span style="color:red">*</span></td>
						                <td ><input type="number" name="quantityReExported" id="quantityReExported" ></td>
						                
						                <td>Quantity in storage at<br> the end of the year <span style="color:red">*</span></td>
...
if(x3==""){
alert("Please Enter Quantity of waste received during the year from Domestic sources");
document.getElementById("totalQuantity").focus();
 return false;
  }
var x4 = document.getElementById("dispatchedQuantityToDisposalFacility").value;
if(x4==""){
alert("Please Enter Quantity of waste received during the year Imported");
...
if(x5==""){
alert("Please Enter Quantity recycled or co-processed or used");
...
if(x6==""){
alert("Please Enter Quantity of waste generated");
document.getElementById("dispatchedQuantityToOthers").focus();
 return false;
  }
var x7 = document.getElementById("utilisedQuantityInHouse").value;
if(x7==""){
alert("Please Enter Quantity of waste disposed");
document.getElementById("utilisedQuantityInHouse").focus();
 return false;
  }
var x8 = document.getElementById("quantityReExported").value;
if(x8==""){
alert("Please Enter  Quantity re-exported wherever applicable ");
document.getElementById("quantityReExported").focus();
 return false;
  }
var x9 = document.getElementById("quantityInstorageEndYear").value;
if(x9==""){
