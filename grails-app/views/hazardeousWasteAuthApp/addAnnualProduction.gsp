...
selectmenu1.onchange=function()
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					<tr bgcolor="#D1D1D1">
					<td align="center" valign="middle"  class="headngblue">Production during the year (product

							wise), wherever applicable</td>
					</tr>
 					<tr><td><table 	class="tblbdr">
 					
 					<tr bgcolor="#A8DAF3">
 					<td width="150px" align="center"  class="txt" >Sr.no</td>
                     <td width="150px" align="center"  class="txt" > Product Name <span style="color:red">*</span></td>
  ...
  <td><div style="width: 500px;  vertical-align: middle"><span
					...
					<tr>
					<td align="left"> 
					<span class="txt" style="color: navy"><b>List of Production during the year (product wise).</b></span>
					<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
