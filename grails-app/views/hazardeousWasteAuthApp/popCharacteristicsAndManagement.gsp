...
<body>
        <g:form name="myForm" method="post" action="popCharacteristicsAndManagementSave" >
        <br>
    ...
    <table border="1" width="95%" align="center" cellpadding="0"	cellspacing="0" class="tblbdr" bordercolor="black">
       ...
       <g:each in="${hazardousWasteDetailsList}" status="i" var="hazardousWasteDetailsListInstance">
  	        <tr align="center" >
  			    ...
  			    <td align="center" class="txt4"><input style="width:100px;" class="txt4" type="text" value="${instCharacteristicsAndManagementHWM?.characterisitics}" name="characterisitics" id="characterisitics"></td>
  			    <td align="center" class="txt4"><input style="width:100px;" class="txt4" type="text" value="${instCharacteristicsAndManagementHWM?.utilization}" name="utilization" id="utilization"></td>
  			    <td align="center" class="txt4"><input style="width:100px;" class="txt4" type="text" value="${instCharacteristicsAndManagementHWM?.ifNotUtilized}" name="ifNotUtilized" id="ifNotUtilized"></td>
  			    <td align="center" class="txt4"><input style="width:100px;" class="txt4" type="text" value="${instCharacteristicsAndManagementHWM?.arrangementsForTransportation}" name="arrangementsForTransportation" id="arrangementsForTransportation"></td>
  			    <td align="center" class="txt4"><input style="width:100px;" class="txt4" type="text" value="${instCharacteristicsAndManagementHWM?.environmentalSafeguards}" name="environmentalSafeguards" id="environmentalSafeguards"></td>	
           </tr>		
       </g:each>	
       	     <g:if test="${hazardousWasteDetailsList.size()==0}">
  			    ...
  			    <g:else>
  			        <tr>
                   <td colspan="12" align="center"><input type="submit" name="Add" value="Update" class="actionbutton"></td>
                   </tr>
  			    </g:else>
