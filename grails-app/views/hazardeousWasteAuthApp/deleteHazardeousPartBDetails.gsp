 ...
 return false;
    ...
    <table border="1" width="95%" align="center" cellpadding="0"	cellspacing="0" class="tblbdr" bordercolor="black">
       ...
       <g:each in="${hazardousWasteDetailsList}" status="i" var="hazardousWasteDetailsListInstance">
  			...
  			<a href="#" onclick="window.open('<%=request.getContextPath()%>/hazardeousWasteAuthApp/deleteHazardeousPartBDetailsRecord/<%=hazardousWasteDetailsListInstance.id%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" class="actionbutton">  <input type="button" value="Delete" class="actionbutton">	</a>
  			</td>
  			</tr>		
       </g:each>	
