...
<body>
<g:form id="general" name="general" method="post" enctype="multipart/form-data" action="saveDocsNewFormat" >
...
<tr bgcolor="#A8DAF3">
	...
	<tr bgcolor="#E8F6F9">
		<td align="right" class="headngblue"><%=a%></td>
		<% if(false){ %>
		<td align="right" class="headngblue"><%=(docList.get(i)).documentType%><span style="color:red">*</span></td>
		<% } else { %>
	...
	<tr bgcolor="#E8F6F9">
		...
		<tr>
			...
			<g:link action="viewFileNewFormat" params="[appliLoc:fooVar,docName:docN,docType:'pdf',docId:docId]" >Download</g:link></td>
		</tr>
		</g:each>
</g:form>
