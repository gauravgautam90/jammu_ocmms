...
<body>
<g:form name="waterSourceUses" method="post" action="deleteEWasteGenDetails" >
<table align="center">
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="155" align="center"
					...
					class="top-lnks"><a href="#" rel="country1">Waste generation Details</a></td>
 ...
 <g:each in="${wasteGenList}" status="i" var="wasteGenDetails">
  	...
  	<td ><span class="txt style6">${wasteGenDetails.type}
  					...
  					<td ><span class="txt style6">${wasteGenDetails.category}
                        ...
                        <td ><span class="txt style6">${wasteGenDetails.quantity}
                         ...
                         <td ><span class="txt style6">${wasteGenDetails.unit.unitName}
                        </span></td>
                        <td ><span class="txt style6"><input type="checkbox" name="delete" value="<%=wasteGenDetails.id%>" />
                        </span></td>    
    </tr>		
 </g:each>		
 					<tr bgcolor="#F4F7FB">
  ...
  &nbsp;<b>* Instructions:</b>
  &nbsp;<ul> 
  <li>Please select the checkbox to delete the waste generation details and click "Delete" button</li>
  <li>Select multiple check box and click "Delete" button to delete multiple records</li>
  <li>To edit the waste generation details, delete the waste generation details and then add new one</li>
  </ul>
