...
<body>
<g:form name="waterSourceUses" method="post" action="saveEWProductionDetails" >
<table width="100%">
<tr>
<td>
		...
		<table width="100%"  border="01" bordercolor="black" align="left" cellpadding="2" cellspacing="0" class="">
				...
				<tr bgcolor="#D1D1D1">
					<td colspan="7"  align="center" valign="middle"  class="headngblue">Production Details </td>
				</tr> 
                ...
                <td width="10%" align="center" class="headngblue">Installed Capacity(MTA)</td>
		  	...
		  	<tr>
               ...
               <br> <span class="sidetxt">(max. 250 chars)</span></td>
                ...
                <td  align="center" class="headngblue">
                  ...
                  <input type="text"  name="capacity" size="20" class="txt4" />
...
<div style="border":1px solid gray; width:720px; margin-bottom: 1em; padding: 10px" >
 <table width="100%"  border="0" bordercolor="black" align="center" cellpadding="0" cellspacing="0"  >
 				...
 				<tr><td> <span class="txt" style="color: navy"><b>List of Production Details added.</b></span>
 ...
 <g:each in="${productDetailsList}" status="i" var="productDetails">
  	<tr align="center" >
  					...
  					<td ><span class="txt style6">${productDetails.product}
                        ...
                        <td ><span class="txt style6">${productDetails.capacity}
                        </span></td>
 ...
 <script language="JavaScript" type="text/javascript">
  ...
  frmvalidator.EnableMsgsTogether();  
   ...
   frmvalidator.addValidation("capacity","dec","Installed Capacity should be numeric");
