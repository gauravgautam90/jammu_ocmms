...
<table align="center" width="100%">
	...
	<tr align="center">
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
					...
					<td align="center" valign="middle"  class="headngblue">Production Details </td>
				</tr> 
 					<tr><td><table width="100%">
 					
 					<tr bgcolor="#A8DAF3" >
			  
                <td  width="50%" align="center" class="headngblue">Product Name</td>
                <td width="50%" align="center" class="headngblue">Installed Capacity(MTA)</td>
 ...
 <g:each in="${productDetailsList}" status="i" var="productDetails">
  	<tr align="center" >
  					...
  					<td bgcolor="#E8F6F9"><span class="txt style6">${productDetails.product}
                        ...
                        <td bgcolor="#E8F6F9"><span class="txt style6">${productDetails.capacity}
                        </span></td>
