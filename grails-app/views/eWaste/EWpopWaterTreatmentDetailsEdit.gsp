...
<body>
<g:form name="waterSourceUses" method="post" action="deleteEWWaterTreatmentDetails" >
<table align="center">
...
<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="155" align="center"
					...
					class="top-lnks"><a href="#" rel="country1">Water Treatment Details</a></td>
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3" align="center">
 					 <td width="50%" class="headngblue" ><div  class="style3">Source Treatment</div></td>
 ...
 <g:each in="${waterGenarationList}" status="i" var="powerDetails">
  ...
  &nbsp;<b>* Instructions:</b>
  &nbsp;<ul> 
  <li>Please select the checkbox to delete the water treatment details and click "Delete" button</li>
  <li>Select multiple check box and click "Delete" button to delete multiple records</li>
  <li>To edit the water treatment details, delete the water treatment details and then add new one</li>
  </ul>
