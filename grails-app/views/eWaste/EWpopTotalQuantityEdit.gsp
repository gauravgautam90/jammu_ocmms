...
<g:form method="post" action="editEWasteTotalQuantityDetails" >
    <table align="center">
                ...
                <div >
                    ...
                    <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                        <tr>
                            ...
                            <td width="420" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">Total Quantity Details</a></td>
                    ...
                    <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
                        ...
                        <tr><td><table class="tblbdr" width="100%">
                            ...
                            <tr bgcolor="#A8DAF3" align="center">
                                ...
                                <td width="20%" class="headngblue" ><div  class="style3">Basel Convention No.</div></td>
                                <td width="20%" class="headngblue" ><div  class="style3">Nature of eWaste</div></td>
                            ...
                            <g:each in="${totalQualityDetailList}" status="i" var="totalQualityDetailInst">
                                <tr align="center" align="center">
                                    ...
                                    <td bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=totalQualityDetailInst.id%>"/>
                                    </span></td>
    ...
    <div align="left" class="txt" style="color: navy">
      ...
      &nbsp;<b>* Instructions:</b>
      &nbsp;<ul>
      <li>Please select the checkbox to delete the total quantity details and click "Delete" button</li>
      <li>Select multiple check box and click "Delete" button to delete multiple records</li>
      <li>To edit the total quantity details, delete the total quantity details and then add new one</li>
      </ul>
