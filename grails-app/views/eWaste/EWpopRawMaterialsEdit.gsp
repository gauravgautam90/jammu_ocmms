...
<g:javascript library="prototype" />
  ...
  <g:form name="editWaterSolidDispos" method="post" action="editEWRawMaterialDetails" >
 <table align="center">
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3" align="center">
 					 <td width="20%" class="headngblue" ><div  class="style3">Year</div></td>
                       <td width="20%" class="headngblue" ><div  class="style3">Raw-Material Name</div></td>
 ...
 <g:each in="${rawMaterialDetailList}" status="i" var="rawMaterialDetailInst">
  <tr align="center" align="center">
   ...
   <td bgcolor="#E8F6F9"><span class="txt style6">${rawMaterialDetailInst.year} </span></td>
  					 <td bgcolor="#E8F6F9"><span class="txt style6">${rawMaterialDetailInst.rawMaterialName} </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${rawMaterialDetailInst.quantity} </span></td>
  					 
  					
                         <td bgcolor="#E8F6F9"><span class="txt style6">${rawMaterialDetailInst.unit.unitName}
                        </span></td>
