...
<body>
<g:form name="waterSourceUses" method="post" action="saveEWWaterTreatmentDetails" >
<table width="100%">
<tr>
<td>
		...
		<table width="100%"  border="01" bordercolor="black" align="left" cellpadding="2" cellspacing="0" class="">
				...
				<tr bgcolor="#D1D1D1">
					<td colspan="5"  align="center" valign="middle"  class="headngblue">Waste Water Treatment Details</td>
				</tr> 
				
				<tr bgcolor="#A8DAF3" >
                <td  width="50%" align="center" class="headngblue">Source Treatment</td>
...
<div style="border":1px solid gray; width:720px; margin-bottom: 1em; padding: 10px" >
 <table width="100%"  border="0" bordercolor="black" align="center" cellpadding="0" cellspacing="0"  >
 				...
 				<tr><td> <span class="txt" style="color: navy"><b>Waste Water Treatment Details added.</b></span>
