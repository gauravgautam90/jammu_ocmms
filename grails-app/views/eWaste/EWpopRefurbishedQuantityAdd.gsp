...
<body>
<g:form name="waterSourceModeUses" method="post" action="saveEWasteRefurbishedQuantityDetails" >
    ...
    <table width="100%">
            ...
            <td>
                ...
                <table width="100%"  border="01" bordercolor="black" align="left" cellpadding="2" cellspacing="0" class="">
                    ...
                    <tr bgcolor="#D1D1D1">
                        ...
                        <td colspan="7" align="center" valign="middle"  class="headngblue">Quantity of Refurbished EWaste Details</td>
                    </tr>
        ...
        <tr><td>
            ...
            <table width="100%"  border="0" bordercolor="black" align="center" cellpadding="0" cellspacing="0"  >
                ...
                <tr>
                    <td><span class="txt" style="color: navy"><b>List of Quality Refurbished Details added.</b></span>
                        <table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
                            ...
                            <g:each in="${refurbishedQuantityDetailList}" status="i" var="refurbishedQuantityDetailInst">
                                <tr align="center" >
                                    <td><span class="txt style6">${refurbishedQuantityDetailInst.eWasteName} </span></td>
                                    <td><span class="txt style6">${refurbishedQuantityDetailInst.quantity} </span></td>
                                    <td ><span class="txt style6">${refurbishedQuantityDetailInst.unit.unitName} </span></td>
