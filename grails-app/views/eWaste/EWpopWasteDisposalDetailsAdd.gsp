...
<body>
<g:form name="waterSourceUses" method="post" action="saveEWasteDisposalDetails" >
<table width="100%">
<tr>
<td>
		...
		<table width="100%"  border="01" bordercolor="black" align="left" cellpadding="2" cellspacing="0" class="">
				...
				<tr bgcolor="#D1D1D1">
					<td colspan="7"  align="center" valign="middle"  class="headngblue">Waste Disposal Details</td>
				</tr> 
...
<div style="border":1px solid gray; width:720px; margin-bottom: 1em; padding: 10px" >
 <table width="100%"  border="0" bordercolor="black" align="center" cellpadding="0" cellspacing="0"  >
 				...
 				<tr><td> <span class="txt" style="color: navy"><b>List of Waste Disposal Details added.</b></span>
 ...
 <g:each in="${wasteDisposalList}" status="i" var="WasteDisposalDetails">
  	...
  	<td ><span class="txt style6">${WasteDisposalDetails.type}
  					...
  					<td ><span class="txt style6">${WasteDisposalDetails.category}
                        ...
                        <td ><span class="txt style6">${WasteDisposalDetails.unit.unitName} </span></td>
