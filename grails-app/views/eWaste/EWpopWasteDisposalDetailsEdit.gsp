...
<body>
<g:form name="waterSourceUses" method="post" action="deleteEWasteDisposalDetails" >
<table align="center">
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="155" align="center"
					...
					class="top-lnks"><a href="#" rel="country1">Waste Disposal Details</a></td>
 ...
 <g:each in="${wasteDisposalList}" status="i" var="WasteDisposalDetails">
  	...
  	<td ><span class="txt style6">${WasteDisposalDetails.type}
                        </span></td>
  					<td ><span class="txt style6">${WasteDisposalDetails.category}
                        </span></td>
                        
                       
                        <td ><span class="txt style6">${WasteDisposalDetails.quantity}
                        </span></td>
                       
                         <td ><span class="txt style6">${WasteDisposalDetails.unit.unitName}
                        </span></td>
                        <td ><span class="txt style6"><input type="checkbox" name="delete" value="<%=WasteDisposalDetails.id%>" />
                        </span></td>    
    </tr>		
 </g:each>		
 					<tr bgcolor="#F4F7FB">
  ...
  &nbsp;<b>* Instructions:</b>
  &nbsp;<ul> 
  <li>Please select the checkbox to delete the waste disposal details and click "Delete" button</li>
  <li>Select multiple check box and click "Delete" button to delete multiple records</li>
  <li>To edit the waste disposal details, delete the waste disposal details and then add new one</li>
  </ul>
