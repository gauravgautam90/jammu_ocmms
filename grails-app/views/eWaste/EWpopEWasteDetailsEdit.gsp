...
<body>
<g:form name="waterSourceUses" method="post" action="deleteEWasteDetails" >
<table align="center">
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="110" align="center"
					...
					class="top-lnks"><a href="#" rel="country1">E-Waste Details</a></td>
 ...
 <g:each in="${ewasteDetailsList}" status="i" var="ewasteDetails">
  	...
  	<td ><span class="txt style6">${ewasteDetails.name}
  					...
  					<td ><span class="txt style6">${ewasteDetails.quantity}
                        ...
                        <td ><span class="txt style6"><input type="checkbox" name="delete" value="<%=ewasteDetails.id%>" />
                        </span></td>    
    </tr>		
 </g:each>		
 					<tr bgcolor="#F4F7FB">
  ...
  &nbsp;<b>* Instructions:</b>
  &nbsp;<ul> 
  <li>Please select the checkbox to delete the e-waste details and click "Delete" button</li>
  <li>Select multiple check box and click "Delete" button to delete multiple records</li>
  <li>To edit the e-waste details, delete the e-waste details and then add new one</li>
  </ul>
