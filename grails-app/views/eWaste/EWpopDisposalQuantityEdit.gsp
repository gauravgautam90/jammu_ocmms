...
<g:form method="post" action="editEWasteDisposalQuantityDetails" >
    <table align="center">
                ...
                <div >
                    ...
                    <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                        <tr>
                            ...
                            <td width="420" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">Disposal Quantity Details</a></td>
                        ...
                        <tr><td><table class="tblbdr" width="100%">
                            ...
                            <g:each in="${disposalQuantityDetailsList}" status="i" var="disposalQuantityDetailsListInst">
                                <tr align="center" align="center">
                                    ...
                                    <td bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=disposalQuantityDetailsListInst.id%>"/>
                                    </span></td>
    ...
    <div align="left" class="txt" style="color: navy">
      ...
      &nbsp;<b>* Instructions:</b>
      &nbsp;<ul>
      <li>Please select the checkbox to delete the disposal quantity details and click "Delete" button</li>
      <li>Select multiple check box and click "Delete" button to delete multiple records</li>
      <li>To edit the disposal quantity details, delete the disposal quantity details and then add new one</li>
      </ul>
