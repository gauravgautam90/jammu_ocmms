...
<table align="center" width="100%">
	...
	<tr align="center">
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					<tr bgcolor="#D1D1D1">
					<td align="center" valign="middle"  class="headngblue">Product Details </td>
				</tr> 
 					<tr><td><table width="100%">
 					
 					<tr bgcolor="#A8DAF3" >
			  <td width="25%" align="center" class="headngblue">Year</td>
 ...
 <g:each in="${productDetailsList}" status="i" var="productDetails">
  	<tr align="center" >
  	 <td bgcolor="#E8F6F9"><span class="txt style6">${productDetails.year}
                        </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${productDetails.product}
                        </span></td>
                       
                       
                        <td bgcolor="#E8F6F9"><span class="txt style6">${productDetails.quantity}
                        </span></td>
                        <td bgcolor="#E8F6F9"><span class="txt style6">${productDetails.unit.unitName} </span></td>
