...
<body>
<g:form name="waterSourceUses" method="post" action="deleteEWProductionDetails" >
<table align="center">
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="110" align="center"
					...
					class="top-lnks"><a href="#" rel="country1">Production Details</a></td>
 ...
 <g:each in="${productDetailsList}" status="i" var="productDetails">
  ...
  &nbsp;<b>* Instructions:</b>
  &nbsp;<ul> 
  <li>Please select the checkbox to delete the production details and click "Delete" button</li>
  <li>Select multiple check box and click "Delete" button to delete multiple records</li>
  <li>To edit the production details, delete the production details and then add new one</li>
  </ul>
