...
<table align="center" width="100%">
	...
	<tr align="center">
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 				<tr bgcolor="#D1D1D1">
		<td   align="center" valign="middle"  class="headngblue">Waste Water Generation Details</td>
		</tr> 	
 ...
 <g:each in="${waterGenarationList}" status="i" var="powerDetails">
  	<tr align="center" >
  					<td bgcolor="#E8F6F9"><span class="txt style6">${powerDetails.modeUse} ${powerDetails.otherSource}
                        </span></td>
