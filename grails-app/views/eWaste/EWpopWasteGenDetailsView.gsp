...
<table align="center" width="100%">
 ...
 <g:each in="${wasteGenList}" status="i" var="wasteGenDetails">
  	<tr align="center" >
  	 <td bgcolor="#E8F6F9"><span class="txt style6">${wasteGenDetails.type}
                        </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${wasteGenDetails.category}
                        </span></td>
                       
                       
                        <td bgcolor="#E8F6F9"><span class="txt style6">${wasteGenDetails.quantity}
                        </span></td>
                       
                          <td bgcolor="#E8F6F9"><span class="txt style6">${wasteGenDetails.unit.unitName} </span></td>
    </tr>		
 </g:each>		
