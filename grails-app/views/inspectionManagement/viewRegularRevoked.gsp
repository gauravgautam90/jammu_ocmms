...
if(appClarification.revoke == true){

%>

 <tr  >
                              <td width="150px" align="center" valign="middle" colspan =2 class="headngblue" bgcolor="#A8DAF3"><div align="center" class="style3">Inspection Revoked Details :</div></td>
        </tr>
        <tr >
  ...
  <tr  >
                              <td width="150px" align="right" valign="middle" class="headngblue" bgcolor="#A8DAF3"><div align="right" class="style3">Revoked By:</div></td>
					 ...
					 <tr >
						...
						<td align="left" bgcolor="#E8F6F9" class="txt4"> Revoked </td>
						</tr>
					 
                      <tr >
                        <td width="150px" class="headngblue" bgcolor="#A8DAF3"><div align="right" class="style3">Description:</div></td>
                        <td align="left" bgcolor="#E8F6F9" class="txt4"> ${appClarification.revokeNote}  </td>
                      </tr>
