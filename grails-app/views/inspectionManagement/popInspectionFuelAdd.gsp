...
<body>
<g:form name="" method="post" action="saveInspectionFuelAdd" >
<div align="center">
<table cellpadding="1" cellspacing="1" width="90%" class="tblbdr">
<tr bgcolor="#D1D1D1">
		<td   align="center" valign="middle"  class="headngblue">Fuel Detail </td>
		</tr> 
				<tr align="center" class="error" >  <td> <g:if test="${flash.message}">
												<div class="message">${flash.message}</div>
												</g:if>
												<g:hasErrors bean="${inspectionFuelDetails}">
												<div class="errors">
													<g:renderErrors bean="${inspectionFuelDetails}" as="list" />
												</div>
												</g:hasErrors></td></tr>
				<tr >
			<tr><td>
				<table class="tblbdr" width="100%"  border="0" >
					...
					<tr>
						...
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input type="text"  name="type" id="type" class="txt4" />
						</td>
						
						
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="quantity" type="text" size="15"class="txt4" />
		...
		<td colspan="5" align="center"><input type="submit" name="Add" value="Add" class="actionbutton"></td>
				...
				<tr>
				<td align="center"><span class="txt" style="color: navy"><b>Fuel Details added.</b></span>
...
<%System.out.println("indApplicationDetailsInstance : " +list); %>					
