...
<body>
<g:form name="waterSourceUses" method="post" action="saveInspectionDetailOfHazardousWasteAdd" >
<div align="center">
<table cellpadding="1" cellspacing="1" width="90%" class="tblbdr">
<tr bgcolor="#D1D1D1">
		<td   align="center" valign="middle"  class="headngblue">Hazardous Waste Details </td>
		</tr> 
		...
		<td colspan="5" align="center"><input type="submit" name="Add" value="Add" class="actionbutton"></td>
				...
				<tr>
				<td align="center"><span class="txt" style="color: navy"><b>Hazardous Waste Details.</b></span>
