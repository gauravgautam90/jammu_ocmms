...
<body>
<g:form name="waterSourceUses" method="post" action="saveInspectionLastMonitoringDateAdd" >
<div align="center">
...
<tr bgcolor="#D1D1D1">
			...
			<tr><td>
				<table class="tblbdr" width="100%"  border="0" >
					...
					<input type="hidden" name="appId" value="<%=appId%>">
						<td width="20%" align="center" valign="middle"  class="headngblue">Stack Emmission</td>
						<td width="20%" align="center" valign="middle"  class="headngblue">AAQ</td>
						<td width="20%" align="center" valign="middle"  class="headngblue">Noise</td>
					</tr>
					
					<tr>
						
						<td bgcolor="#E8F6F9" align="center" class="headngblue"> <input type="text"  name="stackEmmission" id="stackEmmission" class="txt4" /> </td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"> <input type="text"  name="aaq" id="aaq" class="txt4" /> </td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"> <input type="text"  name="noise" id="noise" class="txt4" /> </td>
		...
		<td colspan="5" align="center"><input type="submit" name="Add" value="Add" class="actionbutton"></td>
				...
				<tr>
				<td align="center"><span class="txt" style="color: navy"><b>Last moniotring Details added.</b></span>
 ...
 <g:each in="${list}" status="i" var="list">
  <tr align="center" >
                        ...
                        <td bgcolor="#E8F6F9">${list.stackEmmission}</td>
						<td bgcolor="#E8F6F9">${list.aaq}</td>
						<td bgcolor="#E8F6F9">${list.noise}</td>
