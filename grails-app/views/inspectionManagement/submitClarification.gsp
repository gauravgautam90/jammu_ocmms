...
<tr >
					...
					<!-- 
					 ...
					 <tr bgcolor="#F4F7FB">
                       ...
                       <td bgcolor="#E8F6F9" class="headngblue"><g:link action="viewClarificationReportIndustry" controller="inspectionManagement" params="[appliLoc:app.id,docName:'attachRegularClarificationReport',docType:'doc']">View Report</g:link></td>
                      </tr>
                      </g:if>
                      <tr>
