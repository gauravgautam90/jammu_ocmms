...
<script type="text/javascript" language="javascript">window.history.forward(1);</script>
  ...
  <g:form name="AirStackEdit" method="post" action="deleteInspectionDetailOfHazardousWaste" >
 <table align="center">
...
<table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                            <tr>
                              ...
                              <td width="420" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">Hazardou Details</a></td>
