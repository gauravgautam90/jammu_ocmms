...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                            <tr>
                              ...
                              <td width="190" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">Previous Inspection Details </a></td>
 ...
 <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
       ...
       <tr align="center" >
        ...
        <tr >
					 ...
					 <tr bgcolor="#F4F7FB">
                       ...
                       <td ><div align="left"><span class="txt style6">${inspectionNoteInstance.noticeType} </span></div></td>
                       <%}else{%>
  ...
  <tr>
  <%if(inspectionNoteList==null){%>
    <td height="1" colspan="2"  align="middle">Previous Note History Is Empty.</td>
    <%}%>
  </tr>
	<tr>
