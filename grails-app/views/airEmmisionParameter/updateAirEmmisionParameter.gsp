...
document.observe('dom:loaded', function() {
 ...
 {
       new Ajax.Updater("parmSelected",
          "/SPCB/airEmmisionParameter/updateSelect",
        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0s" cellspacing="0" cellpadding="0">
                   ...
                   <g:select optionKey="id" from="${AirEmmisionType.list()}" id="typeSelected" name="typeId"  ></g:select>   
                            ...
                            <tr >
                        <td width="150px" class="headngblue" ><div align="right" class="style3">ParameterName:</div></td>
                        <td align="left"><span class="txt style6">
                        
                         <div id ="parmSelected">
				<g:select optionKey="id"  name="param" from="${paramList}"></g:select>
				</div>
                        </span></td>
                      </tr>
