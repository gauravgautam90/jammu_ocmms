...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <g:if test="${flash.message}">
            ...
            <g:hasErrors bean="${airEmmisionTypeInstance}">
            <div class="errors">
                <g:renderErrors bean="${airEmmisionTypeInstance}" as="list" />
            </div>
            </g:hasErrors>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bordercolor="#990000">
        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr bgcolor="#F4F7FB">
                        <td  width="150px" class="headngblue"><div align="right" class="style3">AirEmmisionType:</div></td>
                       <td ><div align="left">
                         
						 <g:select optionKey="id" from="${AirEmmisionType.list()}" name="type.id" value="${airEmmisionParameterInstance?.type?.id}" ></g:select>
