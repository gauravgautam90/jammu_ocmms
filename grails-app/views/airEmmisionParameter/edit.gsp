  ...
  <tr>
    ...
    <td width="100%" valign="top" bgcolor="#FFFFFF" ><div class="path-bg">&nbsp;</div>
     ...
     <g:if test="${flash.message}">
            ...
            <g:hasErrors bean="${airEmmisionParameterInstance}">
            <div class="errors">
                <g:renderErrors bean="${airEmmisionParameterInstance}" as="list" />
            </div>
            </g:hasErrors>
           
				 <g:form action="update" method="post" >
				   <input type="hidden" name="id" value="${airEmmisionParameterInstance?.id}" />
                <input type="hidden" name="version" value="${airEmmisionParameterInstance?.version}" />
    <table align="center">
<tr align="center">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bordercolor="#990000">
        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0s" cellspacing="0" cellpadding="0">
                  ...
                  ${airEmmisionParameterInstance?.type}
                   
                        
                    </span></td>
                      </tr>
                            <tr >
                        <td width="150px" class="headngblue" ><div align="right" class="style3">Role ID:</div></td>
                        <td align="left"><span class="txt style6">
                        
                       <input type="text" id="name" name="name" value="${fieldValue(bean:airEmmisionParameterInstance,field:'name')}"/>
                        </span></td>
                      </tr>
