...
selectmenu1.onchange=function()
 {    
  ...
  <body>
  <g:form name="waterSourceUses" method="post" action="deleteAuthorisation" >
 ...
 <g:each in="${previousAuthList}" status="i" var="previousAuthListInst">
  ...
  <td bgcolor="#E8F6F9"><span class="txt style6">${previousAuthListInst.BMWApplication_Date}
    ...
    <td height="1" colspan="2" bgcolor="" align="center"><input type="hidden" name="appId" value="<%=indRegInstanceId%>"/><input type="submit" name="Delete" value="Delete" class="actionbutton"></td>
