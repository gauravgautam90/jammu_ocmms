...
<html>
    ...
    <%
				...
				String date1 = new SimpleDateFormat("dd-MM-yyyy hh:mm").format(new Date());
				  ...
				  String district = indApplicationDetailsInstance.indUser.district.districtName
				 ...
				 def feesOnline = FeeBankOtherDetails.findAll("from FeeBankOtherDetails fee where fee.application=?",[indApplicationDetailsInstance])
				  ...
				  def indAddress = indApplicationDetailsInstance.indUser.indAddress+", "+indApplicationDetailsInstance.indUser.indCity+", "+indApplicationDetailsInstance.indUser.tehsil.tehsilName+", "+indApplicationDetailsInstance.indUser.district.districtName
				  def waterCess = "0"
				  def nocFee = "0"
				  def waterCons = "0"
				  def airCons = "0"
...
System.out.println("strin in gps----2---"+strMsg)
...
<!--
 ...
 System.out.println("strin in gps---3----"+strMsg)
 response.sendRedirect("https://www.tpsl.co.in/e_TFMS/ServiceForms/TechprocessServiceProcess.aspx?msg="+strMsg);
 %>
