...
<g:javascript library="prototype" />
  ...
  <body>
<g:form name="waterSourceUses" method="post" action="deleteFeeOtherBankDetailsBMW" >
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <g:each in="${feeDetailsBMWList}" status="i" var="feeDetailsBMWList">
  <tr align="center" >
  <td bgcolor="#E8F6F9"><span class="txt style6">${feeDetailsBMWList.feeFor}
                        </span></td>
  					      <td bgcolor="#E8F6F9"><span class="txt style6">${feeDetailsBMWList.amount}
                        </span></td>
                       
                          <td bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=feeDetailsBMWList.id%>"/>
                        </span></td>
