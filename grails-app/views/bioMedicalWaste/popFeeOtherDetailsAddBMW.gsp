...
selectmenu1.onchange=function()
 {    
  ...
  <body>
  <g:form  method="post" action="saveBankOtherFeeDetailsBMW" name="myForm">
  
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					<tr bgcolor="#D1D1D1">
					<td align="center" valign="middle"  class="headngblue">BMW Fee Details</td>
					</tr>
  ...
  <td bgcolor="#E8F6F9"><span class="txt style6"> <select name="feeFor" id="feeFor" onclick="javascript:select4()" class="txt4">
													      				...
													      				<option value="BMW Fee">BMW Fee</option>
  ...
  <td bgcolor="#E8F6F9"><span class="txt style6">${feeDetailsListInst.feeFor}
        ...
        <!--
 				<tr bgcolor="#F4F7FB" >
 					...
 					<td class="txt style6" align="left" ><%if(feeCheque){%>	<g:def var="fooVar" value="${appDetId}"/><g:link action="viewChequeAttachedFee" controller="bioMedicalWaste" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
<%}%></td>
 					</tr>	
 					-->	
 					</table></td></tr>
