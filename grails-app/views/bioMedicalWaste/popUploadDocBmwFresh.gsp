...
<tr bgcolor="#A8DAF3">
	...
	<tr bgcolor="#E8F6F9">
		<td align="center" colspan="3" class="headngblue"><input type="hidden" name="appFor" value="BMW Fresh"/><input type="hidden" name="indAppId" value="<%=appDetId%>"/><input type="submit" name="Save" value="Save" class="actionbutton"></td>
	</tr>
