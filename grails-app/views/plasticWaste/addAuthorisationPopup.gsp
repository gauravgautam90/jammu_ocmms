...
selectmenu1.onchange=function()
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
					...
					<td align="center" valign="middle"  class="headngblue">Previous Authorisation Details</td>
 					...
 					<tr bgcolor="#A8DAF3">
 					<td width="150px" align="center"  class="txt" >Date of Application for PWMA</td>
                        <td width="150px" align="center"  class="txt" > PWMA Type  </td>
  ...
  <tr align="center" >
					...
					<calendar:resources lang="en" theme="aqua"/> <calendar:datePicker name="PWMApplication_Date" years="1900,2500" dateFormat="%d/%m/%Y" style="Size=12" defaultValue="${new Date()}" class="txt4"/>                                                
					                                               
						</td>
  					
  					 <td bgcolor="#E8F6F9"><span class="txt style6">
  
	         <g:select name="PWMAType" id="PWMAType"  from="${['Fresh','Renewal','Amendment']}" ></g:select>
        ...
        <input name="appId1" type="hidden" value="<%=indAppDetId%>" />
 					...
 					<tr bgcolor="#A8DAF3">
 					<td class="txt style6" colspan="6" align="center">Please Attach Previous Authorisation<input type="file" name="pmwAuthAttach" id="authattach"></td>
  ...
  <td><div style="width: 500px;  vertical-align: middle"><span
 				...
 				<!--	<g:form  method="post" action="saveChequeAttach" name="myForm1" enctype="multipart/form-data">
 					<input name="appId1" type="hidden" value="<%=indAppDetId%>" />
 					 <% System.out.println("4444444444 "+indAppDetId)%>
 					<tr bgcolor="#A8DAF3">
					...
					<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<td width="20%" align="center"  class="txt" >Date of Application for PWM</td>
                        <td width="20%" align="center"  class="txt" >PWMA Type </td>
							  <td width="150px" align="center" class="txt">Authorisation No</td>
							  <td width="150px" align="center" class="txt">Issued date</td>
							  <td width="150px" align="center" class="txt">Valid date</td>
 ...
 <g:each in="${previousAuthDetails}" status="i" var="previousAuthDetailsInst">
  <tr align="center" >
  <td bgcolor="#E8F6F9"><span class="txt style6">${previousAuthDetailsInst.PWMApplication_Date}
                        </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${previousAuthDetailsInst.PWMAType}
                        </span></td>
                        ...
                        <td bgcolor="#E8F6F9">
                 		...
                 		<g:def var="fooVar" value="${previousAuthDetailsInst.wasteManagementFileId}"/><g:link action="viewAuthorisationAttached" controller="plasticWaste" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
                 		</g:if>
...
<%}%></td>
 	...
 	<!--	<td class="txt style6" align="right" colspan="3">Scaned Copy of Drafts     &nbsp;: </td>
 					<td class="txt style6" align="left" colspan="3"><%if(docList8){%>	<g:def var="fooVar" value="${appDetId}"/><g:link action="viewAuthorisationAttached" controller="plasticWaste" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
    <%}%></td>
 					</tr>		 -->
