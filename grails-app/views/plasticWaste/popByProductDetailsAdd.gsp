...
<body>
<g:form name="waterSourceUses" method="post" action="saveByProductDetails" >
<table>
<tr>
<td>
		...
		<table width="100%"  border="01" bordercolor="black" align="left" cellpadding="2" cellspacing="0" class="">
              ...
              <tr bgcolor="#D1D1D1">
					<td colspan="8"  align="center" valign="middle"  class="headngblue">By-Product Details </td>
				</tr> 
				
				<tr bgcolor="#A8DAF3" >
                <td  width="10%" align="center" class="headngblue">By-Products (Name)<span style="color:red">*</span></td>
