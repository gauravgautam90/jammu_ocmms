...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <g:each in="${feeDetailsList}" status="i" var="feeDetailsListInst">
  <tr align="center" >
 					...
 					<td class="txt style6" align="left" colspan="2"><%if(feeCheque){%>	<g:def var="fooVar" value="${appDetId}"/><g:link action="viewChequeAttached" controller="plasticWaste" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
