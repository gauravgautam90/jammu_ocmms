...
<body>
<g:form name="waterSolidWasteGen" method="post" action="saveGenerationDetails" >
<div align="center" style="border":1px solid gray; width:720px; margin-bottom: 1em; padding: 10px">
<table class="tblbdr" align="center">

<tr bgcolor="#D1D1D1">
			<td   align="center" valign="middle"  class="headngblue">Waste Generation Details</td>
		</tr> 
			...
			<tr><td>
				...
				<tr align="left">
				<td align="center"><span class="txt" style="color: navy"><b>List of Waste Generation Details added.</b></span>
				<!--  -->
