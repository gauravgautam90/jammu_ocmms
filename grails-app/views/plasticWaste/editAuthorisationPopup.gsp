...
selectmenu1.onchange=function()
 {    
  ...
  <body>
  <g:form name="waterSourceUses" method="post" action="deleteAuthorisationPopup" >
        ...
        <input name="appId1" type="hidden" value="<%=indAppDetId%>" />  -->
 				...
 				<tr>
					...
					<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
 					<td width="20%" align="center"  class="txt" >Date of Application for PWMA</td>
 ...
 <g:each in="${previousAuthList}" status="i" var="previousAuthListInst">
  <tr align="center" >
  <td bgcolor="#E8F6F9"><span class="txt style6">${previousAuthListInst.PWMApplication_Date}
                        </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${previousAuthListInst.PWMAType}
                        </span></td>
                        <td bgcolor="#E8F6F9"><span class="txt style6">${previousAuthListInst.AuthorisationNo}
                        </span></td>
                        <% System.out.println("previousAuthDetailsInst.Issued_date====="+previousAuthListInst.Issued_date)%>
                        <td bgcolor="#E8F6F9"><g:if test="${previousAuthListInst.Issued_date!='31/12/2999'}">
                                <span class="txt style6">${previousAuthListInst.Issued_date}</span>
                          	</g:if>
                          	<g:else>
                 		...
                 		<g:def var="fooVar" value="${previousAuthListInst.wasteManagementFileId}"/><g:link action="viewAuthorisationAttached" controller="plasticWaste" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
                 		</g:if>
                        </span></td>
                      
                      <td bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=previousAuthListInst.id%>"/>
                        </span></td>  
