...
<g:javascript library="prototype" />
  ...
  <g:form name="editDGSourceMaster" method="post" action="editDGSourceInspection" >
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                            <tr>
                              ...
                              <td width="420" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">D.G. Set Emission Source Details</a></td>
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
 						<td width="12%" align="center" class="headngblue" ><div>Sources of Emission</div></td>
                        ...
                        <td width="12%" align="center" class="headngblue" ><div>Height of Building where D.G.Set is installed</div></td>
                        <td width="12%" align="center" class="headngblue" ><div>Height of the Stack above building</div></td>
                    	<td width="4%" align="center" class="headngblue" ><div  class="style3">Delete</div></td>
                      </tr>
