...
<body>
<g:form name="waterSourceUses" method="post" action="saveTradeEffulentDetails" >
...
<td>
		...
		<table width="100%"  border="1" bordercolor="black" align="center" cellpadding="2" cellspacing="0" class="">
				...
				<tr bgcolor="#D1D1D1">
					<td colspan="6"  align="center" valign="middle"  class="headngblue">Trade Effluent or Combined Effluent</td>
				</tr> 
				
				<tr bgcolor="#A8DAF3" >
                <td  width="35%" align="center" class="headngblue">Date of Sampling and Sample collected by </td>
                <td width="15%" align="center" class="headngblue">pH</td>
                <td width="15%" align="center" class="headngblue">D.O in(mg/l)</td>
                <td width="15%" align="center" class="headngblue">B.D.O in(mg/l)</td>
                <td width="15%" align="center" class="headngblue">C.O.D in(mg/l)</td>
                <td width="15%" align="center" class="headngblue">SS in(mg/l)</td>
                <td width="15%" align="center" class="headngblue">O&G in(mg/l)</td>
                <td width="15%" align="center" class="headngblue">Other Relevant Parameters</td>
                </tr>
		  	...
		  	<calendar:datePicker name="doss" dateFormat="%d/%m/%Y" defaultValue="${new Date()}"/>
            <br>
          </td>
                ...
                <td  align="center" class="headngblue">
                <input type="text"  name="doin" size="4" class="txt4" />
                <br>
                </td>
                <td  align="center" class="headngblue">
              ...
              <td  align="center" class="headngblue">
              <input type="text"  name="cod" size="4" class="txt4" />
              <br>
            </td>
            <td  align="center" class="headngblue">
            <input type="text"  name="ss" size="4" class="txt4" />
            <br>
          </td>
          <td  align="center" class="headngblue">
          <input type="text"  name="og" size="4" class="txt4" />
          <br>
        </td>
        <td  align="center" class="headngblue">
        <input type="text"  name="other" size="4" class="txt4" />
        <br>
      </td>
