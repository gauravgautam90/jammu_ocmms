...
<body>
<g:form name="waterSourceModeUses" method="post" action="saveConsentInspectionReport" >
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					<% 
				def inspReport = ApplicationFileRecord.find("from ApplicationFileRecord afd where afd.indApplication=? and afd.typeOfFile='Inspection Report'",[appId])
				...
				%>
					...
					<td width="45%" align="center" valign="middle" bgcolor="white" class="headngblue"><g:def var="fooVar" value="${appId.id}"/><g:link action="printFreshInspectionReport" controller="applicationProcessingDetails" params="[appliLoc:fooVar,verValue:versionVal]"><span class="innerlink">Print Inspection Report</span></g:link></td>
					<%}%>
 ...
 <div style="display:none; border:0;"  id="ting11"  >
			...
			<td width="30%" align="left" valign="middle" colspan="3" bgcolor="#E8F6F9"  class="headngblue"><input type="text"  name="educationalInstituion" id = "educationalInstituion" value="${fieldValue(bean:consentInspInst,field:'educationalInstituion')}"></td> 
					...
					<%if((appId.applicationFor=='stonecrusher') || (appId.indUser.industryType.industryType=='Hot mix plants') || (appId.applicationFor=='hotmixplants') || (appId.applicationFor=='stonecrusher and hotmixplants')){%>
					<tr class="headngblue" bgcolor="#A8DAF3">
 ...
 <table width="100%"  border="0" align="left" cellpadding="0" cellspacing="0" class="tblbdr" >
		...
		<td colspan="5" align="center"><input type="submit" name="Add" value="Add" class="actionbutton"></td>
					...
					<td   align="center" valign="middle"  class="headngblue">
						<table width="100%">
						 ...
						 <tr>
							<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelOtherDetailAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
							<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelOtherDetailViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
							<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelOtherDetailEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
						  </tr>
						</table>
					</td>
				</tr>
				...
				<td   align="center" valign="middle"  class="headngblue">
					<table width="100%">
					 ...
					 <tr>
						<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelFacilityAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
						<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelFacilityViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
						<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelFacilityEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
					  </tr>
					</table>
				</td>
			</tr>
			...
			<td   align="center" valign="middle"  class="headngblue">
				<table width="100%">
				 <tr>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelWaterConsumptionAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelWaterConsumptionViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHotelWaterConsumptionEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
				  </tr>
				</table>
			</td>
			</tr>
			...
			<td   align="center" valign="middle"  class="headngblue">
				<table width="100%">
				  <tr>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popConsentDetailAdd/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popConsentDetailView/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > View </a></td>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popConsentDetailEdit/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > Delete </a></td>
				  </tr>
				</table>
			</td>
		</tr>
		...
		<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popAddTradeEffluent?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >Add</a>
		<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popViewTradeEffluent?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >View</a>
		<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popTradeEffluentEdit?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >Delete</a>
		</td></tr></table></td>
		</tr>
		...
		<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popAddSewageDetails?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >Add</a>
		<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popViewSewageDetails?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >View</a>
		<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popSewageDetailsEdit?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >Delete</a>
		</td></tr></table></td>
		</tr>
	...
	<td   align="center" valign="middle"  class="headngblue">
		...
		<tr>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGsetAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGsetViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGsetEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
	  </tr>
		</table>
	</td>
</tr>	
...
<td   align="center" valign="middle"  class="headngblue">
	<table width="100%">
	 <tr>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGSourceAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGSourceViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');"> View </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGSourceEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > Delete </a></td>
	  </tr>
	</table>
</td>
</tr>	
...
<td   align="center" valign="middle"  class="headngblue">
	<table width="100%">
	 <tr>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGParameterAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGParameterViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popDGParameterEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
	  </tr>
	</table>
</td>
</tr>
	
	<%}else if((applicationFor=="stonecrusher") || (appId.indUser.industryType.industryType=='Hot mix plants') || (appId.applicationFor=='hotmixplants') || (appId.applicationFor=='stonecrusher and hotmixplants')){%>
	...
	<td   align="center" valign="middle"  class="headngblue">
		<table width="100%">
		<tr>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popStoneSittingCriteriaAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popStoneSittingCriteriaViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');"> View </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popStoneSittingCriteriaEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > Delete </a></td>
	  </tr>
		</table>
	</td>
	</tr>
	...
	<td   align="center" valign="middle"  class="headngblue">
		<table width="100%">
		<tr>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popStoneCrusherControlDevicesAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popStoneCrusherControlDevicesViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');"> View </a></td>
		<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popStoneCrusherControlDevicesEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > Delete </a></td>
	  </tr>
		</table>
	</td>
	</tr>
	...
	<td   align="center" valign="middle"  class="headngblue">
		<table width="100%">
		 <tr>
			<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popNocAuthorityAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
			<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popNocAuthorityViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
			<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popNocAuthorityEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
		  </tr>
		</table>
	</td>
	</tr>
	...
	<td   align="center" valign="middle"  class="headngblue">
		<table width="100%">
		 <tr>
			<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popWaterConsumptionDetailAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
			<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popWaterConsumptionDetailViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
			<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popWaterConsumptionDetailEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
		  </tr>
		</table>
	</td>
	</tr>
	...
	<td   align="center" valign="middle"  class="headngblue">
		<table width="100%">
		 <tr>
			...
			<td   align="center" valign="middle"  class="headngblue">
				<table width="100%">
				 <tr>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popBrickSittingCriteriaAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popBrickSittingCriteriaViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');"> View </a></td>
					<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popBrickSittingCriteriaEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > Delete </a></td>
				  </tr>
				</table>
			</td>
			</tr>
			...
			<td   align="center" valign="middle"  class="headngblue">
				<table width="100%">
				<tr>
				<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popBrickKilnAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
				<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popBrickKilnViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
				<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popBrickKilnEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
			  </tr>
				</table>
			</td>
			</tr>
				...
				<!-----------end------------>
					...
					<tr>
						...
						<td   align="center" valign="middle"  class="headngblue">
							<table width="100%">
							  <tr>
								<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popProductDetailsAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
								<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popProductDetailsViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > View </a></td>
								<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popProductDetailsEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > Delete </a></td>
							  </tr>
							</table>
						</td>
					</tr>
					...
					<td   align="center" valign="middle"  class="headngblue">
							<table width="100%">
							  <tr>
								<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHazardActivityGenDetailsAddInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
								<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHazardActivityGenDetailsViewInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');"> View </a></td>
								<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popHazardActivityGenDetailsEditInspection/<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" > Delete </a></td>
							  </tr>
							</table>
					</td>
			</tr>
					...
					<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popAirStackAddInspection/${appId}', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >Add</a>
					<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popAirStackViewInspection/${appId}', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >View</a>
					<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popAirStackEditInspection/${appId}', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >Delete</a>
					...
					<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popAddWaterBudget?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >Add</a>
					<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popViewWaterBudgetDetails?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >View</a>
					<td  bgcolor="#E8F6F9"  align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popWaterBudgetDetailsEdit?appliId=<%=appId%>', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" >Delete</a>
		...
		<td   colSpan=3 align="center" valign="middle"  class="headngblue">
			<table width="100%">
			 <tr>
				<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popFeesfromOfficerAdd/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Add </a></td>
				<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popFeesfromOfficerView/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');"> View </a></td>
				<td align="center"><a href="#" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/popFeesfromOfficerEdit/<%=appId%>', 'ApplicationHistory', 'WIDTH=800,HEIGHT=500,scrollbars=1,resizable=yes');" > Delete </a></td>
			  </tr>
			</table>
		</td>
		</tr>			  
