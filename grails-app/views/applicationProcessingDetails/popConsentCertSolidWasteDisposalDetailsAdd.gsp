...
<body>
<g:form name="waterSourceUses" method="post" action="saveConsentCertSolidWasteDisposal" >
<table>
<tr>
<td>
		...
		<table width="90%"  border="1" bordercolor="black" align="center" cellpadding="2" cellspacing="0" class="">
				...
				<tr bgcolor="#D1D1D1">
					<td colspan="5"  align="center" valign="middle"  class="headngblue">Solid Waste Disposal Details </td>
				</tr> 
				
				<tr bgcolor="#A8DAF3" >
                <td  width="25%" align="center" class="headngblue">Type of waste </td>
                <td width="15%" align="center" class="headngblue">Quantity</td>
                <td width="15%" align="center" class="headngblue">Mode of disposal</td>
		  	...
		  	<tr>
                <td   align="center" class="headngblue">
                  <input type="text"  name="typeofWaste" class="txt4"/><input maxlength="250" type="hidden" name="appId" value="<%=appDetId%>">
               <br> <span class="sidetxt">(max. 250 chars)</span></td>
                <td  align="center" class="headngblue">
                  
                  
                  
                  <input type="text"  name="quantity" size="10" class="txt4" />
                  <br><span class="sidetxt">(in TPA)</span>
                </td>
                <td  align="center" class="headngblue">
                  <g:select optionKey="id"  class="txt4" from="${WaterDisposalModeMaster.list()}" name="disMode" ></g:select>
                <br><span class="sidetxt">(select mode of disposal)</span>
                </td>
...
<div style="border":1px solid gray; width:720px; margin-bottom: 1em; padding: 10px; align:center" >
 <table width="90%"  border="0" bordercolor="black" align="center" cellpadding="0" cellspacing="0"  >
 				...
 				<tr><td> <span class="txt" style="color: navy"><b>List of Solid Waste Disposal Details added.</b></span>
 				<table border="1" class="tblbdr" cellpadding="0" cellspacing="0" bordercolor="black">
 				<tr bgcolor="#A8DAF3" >
 				
                  <td  width="25%" align="center" class="headngblue">Type of waste </td>
                <td width="15%" align="center" class="headngblue">Quantity(in TPA)</td>
                <td width="15%" align="center" class="headngblue">Mode of disposal</td>
              	</tr>
 <g:each in="${CosentCertSolidWasteDisposalDetailsList}" status="i" var="productDetails">
  	<tr align="center" >
  					<td ><span class="txt style6">${productDetails.typeofWaste}
                        </span></td>
                        <td ><span class="txt style6">${productDetails.quantity}
                        </span></td>
                        <td ><span class="txt style6">${productDetails.disMode}
                        </span></td>
 ...
 <script language="JavaScript" type="text/javascript">
  ...
  frmvalidator.addValidation("typeofWaste","req","Please enter type of waste");
