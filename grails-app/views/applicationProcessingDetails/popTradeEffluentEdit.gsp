...
<body>
<g:form name="tradeEffluentEdit" method="post" action="deleteTradeEffluentDetails" >
			...
			<td align="center" class="headngblue">Delete</td>
              	...
              	%>
              					<td ><span class="txt style6">${date2}
                                    ...
                                    <td ><span class="txt style6"><input type="checkbox" name="delete" value="<%=tradeEffulentList.id%>" />
                                    </span></td>   
