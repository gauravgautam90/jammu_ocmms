...
<body>
<g:form name="tradeEffluentEdit" method="post" action="deleteConsentDetails" >
              	...
              	%>
                        ...
                        <td ><span class="txt style6">${consentDetailsinst.number}
                              ...
                              <td ><span class="txt style6">${date2}
                                    ...
                                    <td ><span class="txt style6"><input type="checkbox" name="delete" value="<%=consentDetailsinst.id%>" />
                                    </span></td>   
