...
<body>
<g:form name="waterSourceUses" method="post" action="deleteProductDetails" >
<table align="center">
	...
	<tr align="center">
		...
		<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3" >
	<td width="30%" align="center" class="headngblue">Product/By-Product Name
				</td>
				<td  width="15%" align="center" class="headngblue">Maximum Quantity(in TPA)</td>
