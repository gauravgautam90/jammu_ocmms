...
<g:javascript library="prototype" />
  ...
  <g:form name="editBrickKilnDetail" method="post" action="editBrickKilnDetailInspection" >
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                            <tr>
                              ...
                              <td width="420" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">Brick Kiln Details</a></td>
 ...
 <g:each in="${brickList}" status="i" var="brickInst">
  <tr align="center" >
                        ...
                        <td  bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=brickInst.id%>"/>
                        </span></td>
