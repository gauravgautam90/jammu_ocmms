...
<body>
<g:form name="waterSourceUses" method="post" action="deleteHotelDetails" >
<table align="center">
	...
	<tr align="center">
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="110" align="center"
					...
					class="top-lnks"><a href="#" rel="country1">Hotel Details</a></td>
		...
		<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3" >
	<td width="30%" align="center" class="headngblue">Hotel/Restaurant Facility 
				</td>
 ...
 <g:each in="${productDetailsList}" status="i" var="productDetails">
  ...
  &nbsp;<b>* Instructions:</b>
  &nbsp;<ul> 
  <li>Please select the checkbox to delete the hotel details and click "Delete" button</li>
  <li>Select multiple check box and click "Delete" button to delete multiple records</li>
  <li>To edit the hotel details, delete the hotel details and then add new one</li>
  </ul>
