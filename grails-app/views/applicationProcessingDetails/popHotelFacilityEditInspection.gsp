...
<g:javascript library="prototype" />
  ...
  <g:form name="editWaterSolidDispos" method="post" action="editHotelFcilityDetailInspection" >
 ...
 <g:each in="${hotelFacilitylist}" status="i" var="hotelFacilityInst">
  <tr align="center" >
  					...
  					<td bgcolor="#E8F6F9"><span class="txt style6">${hotelFacilityInst.facilityDetail} </span></td>
  					 <td bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=hotelFacilityInst.id%>"/>
                        </span></td>
