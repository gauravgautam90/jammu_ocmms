...
<body>
<g:form name="waterSourceModeUses" method="post" action="saveHotelOtherDetailInspection" >
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
				...
				<% System.out.println("type...."+type) %>							
           		...
           		<td colspan="6" align="center"><input type="submit" name="Add" value="Add" class="actionbutton">
