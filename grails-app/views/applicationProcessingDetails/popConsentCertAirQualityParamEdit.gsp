...
<body>
<g:form name="waterSourceUses" method="post" action="deleteConsentCertAirQualityParam" >
<table align="center">
 ...
 <g:each in="${prameterDetailsList}" status="i" var="productDetails">
  ...
  &nbsp;<b>* Instructions:</b>
  &nbsp;<ul> 
  <li>Please select the checkbox to delete the Air quality parameter details and click "Delete" button</li>
  <li>Select multiple check box and click "Delete" button to delete multiple records</li>
  <li>To edit the product details, delete the air quality parameter details and then add new one</li>
  </ul>
