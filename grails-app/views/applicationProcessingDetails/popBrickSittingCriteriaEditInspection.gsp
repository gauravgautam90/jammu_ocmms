...
<g:javascript library="prototype" />
  ...
  <g:form name="editBrickSittingCriteria" method="post" action="editBrickSittingCriteriaInspection" >
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                            <tr>
                              ...
                              <td width="420" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">Brick Kiln Siting Criteria Details</a></td>
 ...
 <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        ...
                        <td width="20%" align="center" class="headngblue" ><div  class="style3">Distance fron Unit/Proposed site (In Meters)</div></td>
 ...
 <g:each in="${brickSittingCriteriaList}" status="i" var="brickSittingCriteriaInst">
  <tr align="center" >
                        ...
                        <td bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=brickSittingCriteriaInst.id%>"/>
                        </span></td>
