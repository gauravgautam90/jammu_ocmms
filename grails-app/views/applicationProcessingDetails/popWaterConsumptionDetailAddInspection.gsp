...
<body>
<g:form name="saveWaterWasteDischrgeDetail" method="post" action="saveWaterWasteDischrgeDetailInsp" >
...
<tr bgcolor="#D1D1D1">
			...
			<tr><td>
				<table width="90%"  border="0" cellpadding="1" cellspacing="1" class="tblbdr">
					<tr bgcolor="#A8DAF3">
					<td width="20%" align="center" valign="middle"  class="headngblue">Source of water supply</td>
	...
	<g:select  from="${WaterSourceMaster.list()}" name="sourceOfWaterSupply" class="txt4" ></g:select>
				...
				<tr align="left">
				<td align="left"><span class="txt" style="color: navy"><b>List of Water Source Details added.</b></span>
				<!--  -->
 ...
 <table width="90%"  border="0" align="left" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        ...
                        <td width="30%" class="headngblue" ><div  class="style3">Quantity</div></td>
