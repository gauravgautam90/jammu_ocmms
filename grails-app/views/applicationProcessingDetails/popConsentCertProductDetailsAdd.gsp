...
<td>
		...
		<table width="90%"  border="1" bordercolor="black" align="center" cellpadding="2" cellspacing="0" class="">
				...
				<tr bgcolor="#A8DAF3" >
                <td  width="25%" align="center" class="headngblue">Product/By-Product Name </td>
                <td width="15%" align="center" class="headngblue">Maximun Quantity</td>
		  	...
		  	<tr>
                ...
                <textarea	name="product" rows="2" cols="20" class="txt4"></textarea><br><span class="sidetxt">(Max size 1000)</span>
                ...
                <br><span class="sidetxt">(select unit)</span>
                </td>
