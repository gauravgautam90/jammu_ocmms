...
<body>
<g:form name="waterSourceModeUses" method="post" action="saveHotelWaterConsumptionInspection" >
 				 ...
 				 <tr><!-- Div area for errors-->
 					...
 					<table width="100%" border="0" >
						...
						<tr>	  
							  ...
							  <g:select class="txt4" optionKey="id"  from="${HotelWaterConsumptionMaster.list()}"  name="type1" ></g:select>
...
<script language="JavaScript" type="text/javascript">
 var frmvalidator  = new Validator("waterSourceModeUses");
  ...
  frmvalidator.addValidation("type1","req","Please enter details :'type'");
