...
<body>
<g:form name="waterSourceUses" method="post" action="saveConsentCertEffQualityParam" >
<table>
...
<td>
		...
		<table width="90%"  border="1" bordercolor="black" align="center" cellpadding="2" cellspacing="0" class="">
				...
				<tr bgcolor="#D1D1D1">
					<td colspan="5"  align="center" valign="middle"  class="headngblue">Quality of Treated Effluent Details </td>
				</tr> 
		  	...
		  	<tr>
                ...
                <td   align="center" class="headngblue"><input maxlength="250" type="hidden" name="appId" value="<%=appDetId%>">
                  <g:select   class="txt4" from="${['Treatment','Sewage Treatment']}" name="treatmentType" ></g:select>
               <br> <span class="sidetxt">(select treatment type)</span></td>
              
              
                <td  align="center" class="headngblue">                         
              
                
                  <g:select  class="txt4" from="${WaterTreatedEffluentQualityMaster.list()}" name="qualityParam" id="qualityParam" ></g:select>
                <br><span class="sidetxt">(select quality parameters)</span>
                </td>
              ...
              <td  align="center" class="headngblue">
                  ...
                  <br><span class="sidetxt">(in mg/l)</span>
                </td>
...
<div style="border":1px solid gray; width:720px; margin-bottom: 1em; padding: 10px; align:center" >
 ...
 // frmvalidator.addValidation("product","maxlength=50","Product Name should be upto 50 characters");
  frmvalidator.addValidation("standardValue","req","Please enter Product Quantity");
 // frmvalidator.addValidation("standardValue","decimal","Quantity should be numeric or decimal");
