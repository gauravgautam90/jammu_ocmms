...
user_management_link.items=[
	["Manage User Profile", "<%=cont%>/userProfile/create"],
...
master_data_link.items=[
	["Office Master", "<%=cont%>/officeMaster/create"],                    
	["District Master", "<%=cont%>/districtMaster/create"],
	["Tehsil Master", "<%=cont%>/tehsilMaster/create"],
	["Group Master", "<%=cont%>/groupMaster/create"],
	["Attach/Remove District from Group", "<%=cont%>/groupDistrictMaster/grpDist"],
	["Department Master", "<%=cont%>/departmentMaster/create"],
	["Designation Master", "<%=cont%>/designationMaster/create"]
]

var consent_master_data_link={divclass:'anylinkmenu', inlinestyle:'', linktarget:''} 
consent_master_data_link.items=[
	["Air Emission Pollution Control Equipment Master", "<%=cont%>/airEmiControlMeasureMaster/create"],
	["Ambient Air Quality Standard Master", "<%=cont%>/ambientAirQualityStandardMaster/create"],	
	["Unit Master", "<%=cont%>/unitMaster/create"],		
	["Water Source Master", "<%=cont%>/waterSourceMaster/create"],
	["Water Uses Master", "<%=cont%>/waterUsesMaster/create"],
	["Water Mode Uses Master", "<%=cont%>/waterModeUseMaster/create"],
	["Water Disposal Mode Master", "<%=cont%>/waterDisposalModeMaster/create"],
	["Water Waste Treatment Category Master", "<%=cont%>/waterWasteTreatmentCategoryMaster/create"],
	["Water Treatment Status Master", "<%=cont%>/waterTreatmentStatusMaster/create"],
	["Water Treated Effluent Quality Parameter Master", "<%=cont%>/waterTreatedEffluentQualityMaster/create"],
	["Sitting Criteria Master", "<%=cont%>/sittingCriteriaMaster/create"],
	["NOC Authority Master", "<%=cont%>/nocAuthorityMaster/create"],
...
waste_master_data_link.items=[
	...
	["Add CBMWTF Office Address for BMW", "<%=cont%>/hcfAddressFacilityBmwMaster/create"],
	["Add CBMWTF Location Address for BMW", "<%=cont%>/hcfAddressFacilityBmwMaster/createCommonFacility"]
]


var manage_industry_link={divclass:'anylinkmenu', inlinestyle:'', linktarget:''} 
manage_industry_link.items=[
	["Industry Registration", "<%=cont%>/industryRegMaster/create1"],                
	["Industry Profile", "<%=cont%>/industryRegMaster/list"],	
	["Manage Industry Type", "<%=cont%>/industryTypeMaster/create"],
	["Delete Application", "<%=cont%>/industryRegMaster/delApp"],
	["Delete Industry", "<%=cont%>/industryRegMaster/deletedind"],
	["Re-Open Applications", "<%=cont%>/industryRegMaster/reOpenApp"]
] 

var transfer_application_data_link={divclass:'anylinkmenu', inlinestyle:'', linktarget:''} 
transfer_application_data_link.items=[
	["Transfer Pending Applications", "<%=cont%>/userMaster/transferPending"],
	["Transfer Completed Applications", "<%=cont%>/userMaster/transferCompleted"]
]

var payment_data_link={divclass:'anylinkmenu', inlinestyle:'', linktarget:''}
payment_data_link.items=[
    ["Payment Verification", "<%=cont%>/userMaster/verification.gsp"]
]
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                      <td><g:link controller="groupMaster" action="searchWhiteUtility"><span class="leftlink">White Category Application</span></g:link></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td>
            ...
            <tr>
              ...
              <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                  <td>
                  <g:link controller="workFlowMaster" action="createManualActivity"><span class="leftlink">Move Application Activity Rights</span></g:link>
                  </td>
                </tr>
              </table></td>
            </tr>
        ...
        <!--Added By Deepak for Revert Consent scr completed application -->
        <tr>
        <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="6" align="left" valign="top"><img src="${createLinkTo(dir:'images2/gif',file:'left_nav.gif')}" width="6" height="31" /></td>
            <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                <td><g:link controller="userMaster" action="revertApplication"><span class="leftlink">Revert Scrutiny Complete Consent Application</span></g:link></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
      </tr>
      <!--Added By Deepak for Revert waste scr completed application -->
      <tr>
      <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="6" align="left" valign="top"><img src="${createLinkTo(dir:'images2/gif',file:'left_nav.gif')}" width="6" height="31" /></td>
          <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
              <td><g:link controller="userMaster" action="revertWasteApplication"><span class="leftlink">Revert Scrutiny Complete Waste Application</span></g:link></td>
            </tr>
          </table></td>
        </tr>
      </table></td>
    ...
    <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
            <td><g:link controller="userMaster" action="revertInCompleteApplication"><span class="leftlink">Revert Scrutiny In-Complete Consent Application</span></g:link></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
              ...
              <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                      <td><a href="#" class="menuanchorclass" rel="transfer_application_data_link"><span class="leftlink">Transfer Applications</span></a></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td>
            ...
            <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                            <td><a href="#" class="menuanchorclass" rel="payment_data_link"><span class="leftlink">Payment</span></a></td>
                        </tr>
                    </table></td>
                </tr>
            </table></td>
              ...
              <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                      <td><g:link controller="applicationPendingDetails" action="insertData"><span class="leftlink">Data Updation for  CPCB India e-Track System</span></g:link></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td>
