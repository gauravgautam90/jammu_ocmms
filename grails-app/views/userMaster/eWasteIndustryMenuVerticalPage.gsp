               ...
               <%if(!session.cafUniqueNo){%>
                <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <td>  <g:link controller="eWaste" action="eWasteCheckBox"><span class="leftlink">Apply For E-Waste</span></g:link>
                     </td>
                      </tr>
                    </table></td>
                  </tr>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td><g:link controller="eWaste" action="delApp"><span class="leftlink">Delete Application</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
             ...
             <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 ...
                 <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                     <td><g:link controller="industryRegMaster" action="showForIndustry"><span class="leftlink">Industry Profile</span></g:link>
						</td>
                   </tr>
                 </table></td>
               </tr>
