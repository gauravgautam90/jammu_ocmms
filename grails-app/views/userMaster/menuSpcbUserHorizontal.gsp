...
<% String cont=request.getContextPath();%>
          <tr>
        <td height="32" align="center" valign="middle" ><g:link controller="userMaster" action="recentAppl1"><span class="top-lnks">Home</span></g:link></td>
            
		<td width="2" align="left" valign="top" background="${createLinkTo(dir:'images2/gif',file:'button_spacer.gif')}"></td>
        <td align="center" valign="middle">
        <g:link controller="userMaster" action="recentAppl1"><span class="top-lnks">Consent Management</span></g:link>
	   ...
	   <td align="center" valign="middle" ><g:link controller="wasteManagementPendingDetails" action="pendingList"><span class="top-lnks">HMW/BMW/MSW</span></g:link></td>
	   
	   <td width="1" align="center" valign="top" background="${createLinkTo(dir:'images2/gif',file:'button_spacer.gif')}"></td>
		<td align="center" valign="middle" ><g:link controller="wasteManagementPendingDetails" action="pendingList2"><span class="top-lnks">PWM</span></g:link></td>
		 <td width="2" align="center" valign="top"
           background="${createLinkTo(dir: 'images2/gif', file: 'button_spacer.gif')}"></td>
       <td align="center" valign="middle"><g:link controller="eWaste" action="pendingList"><span id="eWasteId" onclick="changeColor(this.id)"
               class="top-lnks">E-Waste</span></g:link></td>
