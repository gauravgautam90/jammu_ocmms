...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td>&nbsp;&nbsp;&nbsp;<g:link controller="eWaste" action="pendingList"><span id="ddsfsdfId" onclick="changeColor12(this.id)">E-Waste Applications</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td>&nbsp;&nbsp;&nbsp;<g:link controller="eWaste" action="searchApp"><span id="sdasdId" onclick="changeColor12(this.id)">E-Waste Application Search</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td>&nbsp;&nbsp;&nbsp;<g:link controller="eWaste" action="eWasteSummary"><span id="sfsfsfdId" onclick="changeColor12(this.id)">E-Waste Application Summary</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td>&nbsp;&nbsp;&nbsp;<g:link controller="eWaste" action="delApp"><span id="fsdfsdfsId" onclick="changeColor12(this.id)">Delete Application</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
            ...
            <!-- bhanu commented code start; date: -->
              %{--<tr>
