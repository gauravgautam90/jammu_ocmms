...
user_management_link.items=[
	["Hazardeous Waste", "<g:createLink controller="hazardeousWasteAuthApp" action="createNewFormat" />"],
	["Bio-Medical Waste", "<g:createLink controller="bioMedicalWaste" action="createNewFormat" />"],
	["E-Waste", "<%=cont%>/eWaste/list"],
	["Plastic Waste", "<%=cont%>/plasticWaste/list"],
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td> <a href="#" class="menuanchorclass" rel="user_management_link"><span class="leftlink">Apply Authorization</span></a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
