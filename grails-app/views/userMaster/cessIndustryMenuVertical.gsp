                  ...
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><!--<a href="#" ><span class="leftlink">Apply For Consent</span></a>-->			
                        <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                             <g:link controller="cessReturn" action="createSingle"><span class="leftlink">Apply Cess return</span></g:link>
						</td>
                      </tr>
                    </table></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                             <g:link controller="cessReturn" action="cessIndustryCompletedList"><span class="leftlink">Cess Return Filled List</span></g:link>
						</td>
                      </tr>
                    </table></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><!--<a href="#" ><span class="leftlink">Apply For Concent</span></a>-->			
                        <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                             <g:link controller="cessReturn" action="cessNotices"><span class="leftlink">Cess Return Notices</span></g:link>
						</td>
                      </tr>
                    </table></td>
                  </tr>
