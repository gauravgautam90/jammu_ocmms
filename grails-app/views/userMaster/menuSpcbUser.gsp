                  ...
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><!--<a href="#" ><span class="leftlink">User Profile</span></a>-->          	
                        	<g:link controller="userProfile" action="showForUser"><span class="leftlink">User Management</span></g:link>
						</td>
                      </tr>
                    </table></td>
                  </tr>
              ...
              <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                      <td><g:link controller="groupMaster" action="searchUtility11"><span class="leftlink">Consent Application Processed</span></g:link>
              ...
              <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                      <td><g:link controller="allReports" action="officerIDStatus"><span class="leftlink">Processing Status of Application OfficerID Wise</span></g:link>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td><g:link controller="userMaster" action="changePassword"><span class="leftlink">Change Password</span></g:link></td>
                      </tr>
