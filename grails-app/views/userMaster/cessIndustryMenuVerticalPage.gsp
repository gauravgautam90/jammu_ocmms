                  ...
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><g:link controller="cessReturn" action="createSingle"><span class="leftlink">Apply Cess return</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td><g:link controller="cessReturn" action="cessIndustryCompletedList"><span class="leftlink">Cess Return Filled List</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td><g:link controller="cessReturn" action="cessNotices"><span class="leftlink">Cess Return Notices</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
