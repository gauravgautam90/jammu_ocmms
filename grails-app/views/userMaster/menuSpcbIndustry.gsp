...
def indRegMaste=IndustryRegMaster.get(session.indUser.industryRegMaster.id)
if(indRegMaste){
System.out.println("indRegMaste.category.name------"+indRegMaste.category.name);
}
 %> 
                   <!--  Code for White Category By DEEPAK --->
<body>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <%  if((indRegMaste.category.name).equals("WHITE")){
            	 %>
            	                 <tr>
            	                         ...
            	                         <tr>
            	                             ...
            	                             <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
            	                                 <tr>
            	                                     ...
            	                                     <td>
            	                                         <g:link controller="industryRegMaster" action="createWhiteCategory"><span class="leftlink">Apply for White Category</span></g:link>
            	                                     </td>
            	                                 </tr>
            	                             </table></td>
            	                         </tr>
                 ...
                 <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     ...
                     <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                          <g:link controller="indApplicationDetails" action="applyConsent"><span class="leftlink">Apply for Auto-Renewal</span></g:link>
						</td>
                   </tr>
                 </table></td>
               </tr>
                  ...
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><!--<a href="#" ><span class="leftlink">Apply For Concent</span></a>-->			
                        <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                             <g:link controller="indApplicationDetails" action="applyConsent"><span class="leftlink">Apply For Consent with HWM Authorisation</span></g:link>
						</td>
                      </tr>
                    </table></td>
                  </tr>
                ...
                <tr>
                  ...
                  <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><!--<a href="#" ><span class="leftlink">Apply For Concent</span></a>-->			
                      <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                           <g:link controller="hazardeousWasteAuthApp" action="createNewFormat"><span class="leftlink">Apply For HWM</span></g:link>
						</td>
                    </tr>
                  </table></td>
                </tr>
              ...
              <tr>
                ...
                <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><!--<a href="#" ><span class="leftlink">Apply For Concent</span></a>-->			
                    <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                         <g:link controller="bioMedicalWaste" action="createNewFormat"><span class="leftlink">Apply For BMW</span></g:link>
						</td>
                  </tr>
                </table></td>
              </tr>
            ...
            <tr>
              ...
              <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><!--<a href="#" ><span class="leftlink">Apply For Concent</span></a>-->			
                  <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                       <g:link controller="municipalSolidWaste" action="create"><span class="leftlink">Apply For Municipal Solid Waste</span></g:link>
						</td>
                </tr>
              </table></td>
            </tr>
          ...
          <tr>
            ...
            <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><!--<a href="#" ><span class="leftlink">Apply For Concent</span></a>-->			
                <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                     <g:link controller="eWaste" action="list"><span class="leftlink">E-Waste Applicatioin</span></g:link>
					</td>
              </tr>
            </table></td>
          </tr>
        ...
        <tr>
          ...
          <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><!--<a href="#" ><span class="leftlink">Apply For Concent</span></a>-->			
              <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                   <g:link controller="plasticWaste" action="list"><span class="leftlink">Plastic Waste Application</span></g:link>
					</td>
            </tr>
          </table></td>
        </tr>
              ...
              <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                <tr>
                 ...
                 <tr>
                      <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                      <td>
                      <g:link controller="industryRegMaster"  action="delApp"><span class="leftlink">Delete InProgress Applications</span></g:link>
                      </td>
                    </tr>
                    <tr>
                            <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                            <td>
                            <g:link controller="bioMedicalWaste"  action="delAppBMW"><span class="leftlink">Delete InProgress BMW/HWM Applications</span></g:link>
                            </td>
                          </tr>
              ...
              <tr>
                ...
                <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}"><table width="218" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><!--<a href="#" ><span class="leftlink">Apply For Concent</span></a>-->			
                    <!--<g:link controller="indApplicationDetails" action="doEdit"><span class="leftlink">Apply For Consent</span></g:link>-->
                         <g:link controller="hazardeousWasteAuthApp" action="list"><span class="leftlink">HWM /BMW /MSW Applications</span></g:link>
        					</td>
                  </tr>
                </table></td>
              </tr>
