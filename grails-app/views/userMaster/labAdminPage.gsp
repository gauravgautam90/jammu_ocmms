...
user_management_link.items=[
	["Ambient Air Monitoring", "<g:createLink controller="lab_AmbientAirMonitoring" action="create" />"],
	["Water/Effluent Monitoring", "<g:createLink controller="lab_WaterEffluentMonitoring" action="create" />"],
	["Field Data Sheet List", "<g:createLink controller="labPendingDetails" action="labSampleDashBoard" />"]
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td> <a href="#" class="menuanchorclass" rel="user_management_link"><span class="leftlink">Field Data Sheets</span></a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td><g:link controller="labPendingDetails" action="labDashBoard"><span class="leftlink">Lab Samples</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                ...
                <td valign="top"><table width="224" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="218" height="31" align="left" valign="middle" background="${createLinkTo(dir:'images2/gif',file:'left_midlle.gif')}" ><table width="218" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" align="left" valign="middle"><img src="${createLinkTo(dir:'images2/gif',file:'bullet.gif')}" width="11" height="10" /></td>
                        <td><g:link controller="labPendingDetails" action="labSummary"><span class="leftlink">Lab Summary</span></g:link></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
