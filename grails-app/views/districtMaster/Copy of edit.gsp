...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="225" valign="top" bgcolor="#E6E7E4"><div class="lft-bg">
        ...
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link action="create" >Add District</g:link></div>
      </div>
      <div class="lft-bg">
        <div class="lft-lnks"><img src="${createLinkTo(dir:'gifs',file:'dot.gif')}" /><g:link action="updatedistrict" >Update District</g:link></div>
      </div>
    ...
    <td width="100%" valign="top" bgcolor="#FFFFFF" ><div class="path-bg">&nbsp;</div>
      ...
      <br />
            ...
            <input type="hidden" name="id" value="${districtMasterInstance?.id}" />
                <input type="hidden" name="version" value="${districtMasterInstance?.version}" />
...
<td width="100%" align="center">
    <div >
        ...
        <tr align="left">
          <td colspan="2" ><table width="160" border="0" cellspacing="0" cellpadding="0">
                          <tr >
                            ...
                            <td bgcolor="#5A89D9" class="headng1" width="134">Update District</td>
                        ...
                        <!--<td width="150px" class="headngblue" ><div align="right" class="style3">District* :</div></td>
                          ...
                          <td align="left" >
                             <span class="txt style6">    
                                <g:select optionKey="id" from="" name="" value="" ></g:select>
                                
                        </span></td>
                      </tr>-->
                            <tr align="center" >
                              <td width="150px" align="right" valign="middle" class="headngblue">Enter District :</td>
                        <td align="left" class="value ${hasErrors(bean:districtMasterInstance,field:'districtCode','errors')}">
                                    <input type="text" id="districtCode" name="districtCode" value="${fieldValue(bean:districtMasterInstance,field:'districtCode')}"/>
                                </td>
                        </div></td>
                      </tr>
                      
                      <tr align="center" >
                              <td width="150px" align="right" valign="middle" class="headngblue">Enter District Code :</td>
                        <td align="left" class="value ${hasErrors(bean:districtMasterInstance,field:'districtName','errors')}">
                                    <input type="text" id="districtName" name="districtName" value="${fieldValue(bean:districtMasterInstance,field:'districtName')}"/>
                                </td>
                        </div></td>
                      </tr>
	 ...
	 <span class="button"><g:actionSubmit class="save headngblue" value="Update" style="width: 120px;
      ...
      background: url('${createLinkTo(dir:'gifs',file:'button.gif')}')  no-repeat  " /></span>
   
   
   
    <span class="button"><g:actionSubmit class="delete headngblue" onclick="return confirm('Are you sure?');" value="Delete" 
    		style="width: 120px;
	...
	<!-- 
	  <input type="submit" value="Save" class="headngblue" style="width: 120px;
...
<input type="button" value="Cancel" class="headngblue" style="width: 120px;
