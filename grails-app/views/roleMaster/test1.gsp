...
document.observe('dom:loaded', function() {
	<!-- $("grp").observe("change", respondToSelectRole); -->
 ...
 function respondToSelect(event)
 {
       new Ajax.Updater("roleSelected",
          "/spcbTest/RoleMaster/updateSelect",
  ...
  function respondToSelectRole(event)
 {
       new Ajax.Updater("grpSel",
          "/spcbTest/RoleMaster/updateGrpSel",
        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0s" cellspacing="0" cellpadding="0">
                          <tr >
                            ...
                            <td bgcolor="#5A89D9" class="headng1" width="134">Delete Role</td>
                   ...
                   <g:select optionKey="id" from="${GroupMaster.list()}" id="grpSelected" name="grpSelected" value=""></g:select>
                        ...
                        <td><span class="txt style6">
                         <div id ="roleSelected">
				<g:select optionKey="id"  id="grp" name="grp" from="${RoleMaster.list()}" value=""></g:select>
				</div>
                        </span></td>
                      </tr>
					  <tr>
