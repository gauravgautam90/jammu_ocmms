  ...
  <tr>
    ...
    <g:if test="${flash.message}">
            ...
            <g:form action="update" method="post" >
                ...
                <input type="hidden" name="version" value="${airEmmisionTypeInstance?.version}" />
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bordercolor="#990000">
        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr bgcolor="#F4F7FB">
                        <td  width="150px" class="headngblue"><div align="right" class="style3">Type Name:</div></td>
                       <td ><div align="left">
                         
						 <input type="text" id="typeName" name="typeName" value="${fieldValue(bean:airEmmisionTypeInstance,field:'typeName')}"/>
