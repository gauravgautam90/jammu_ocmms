...
<html>
    <head>
        ...
        <title>Edit WasteManagementPendingDetails</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Edit WasteManagementPendingDetails</h1>
            ...
            <g:form method="post" >
                ...
                <input type="hidden" name="version" value="${wasteManagementPendingDetailsInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
