...
<g:javascript library="prototype" />
  ...
  <body>
  <g:form name="editHazardousChemical" method="post" action="editNocAuthorityDetailMaster" >
 <table align="center">
<tr align="center">
...
<g:each in="${nocAuthorityDetailsInst}" status="i" var="nocAuthorityDetailsInstMaster">
  <tr align="center" >
 					  <td bgcolor="#E8F6F9"><span class="txt style6">${nocAuthorityDetailsInstMaster.authorityDetails} </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${nocAuthorityDetailsInstMaster.status} </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${nocAuthorityDetailsInstMaster.number} </span></td>
  					<td bgcolor="#E8F6F9"><span class="txt style6">${nocAuthorityDetailsInstMaster.date} </span></td>
                    
                        <td  bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=nocAuthorityDetailsInstMaster.id%>"/>
                        </span></td>
        </tr>		
      </g:each>		
