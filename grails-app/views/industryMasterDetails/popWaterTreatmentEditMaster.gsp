...
<g:javascript library="prototype" />
  ...
  <g:form name="watertreat" method="post" action="deleteWaterTreatmentMaster" >
 <table align="center">
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        ...
                        <td width="80px" align="center" class="headngblue" ><div>Quality Parameters</div></td>
                        <td colspan="2" width="250px" align="center" class="headngblue" ><div>Conc. of Pollutants<br>
                        (in mg/l except pH)</div>
                        <br>
                        Untreated &nbsp;| Treated
                        </td>
                        <td width="150px" align="center" class="headngblue" ><div  class="style3">Delete</div></td>
                      </tr>
 <g:each in="${waterWasteTreatmentDetList}" status="i" var="waterWasteTreatment">
  <tr align="center" >
  					...
  					<td bgcolor="#E8F6F9" align="center"><span class="txt style6">${waterWasteTreatment.category}
                        ...
                        <td bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=waterWasteTreatment.id%>"/>
                        </span></td>
