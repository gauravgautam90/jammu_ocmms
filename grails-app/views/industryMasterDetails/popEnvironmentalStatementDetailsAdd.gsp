...
<title>Add Environmental Statement Details</title>
...
<script language="javascript" type="text/javascript">
  ...
  <body>
  <g:form  method="post" action="saveEnvironmentalStatementDetails" name="myForm2">
  
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 	<tr bgcolor="#D1D1D1">
<td align="center" valign="middle"  class="headngblue">Environmental Statement Details</td>
</tr>
 	<tr><td><table class="tblbdr">
 	
 	<tr bgcolor="#A8DAF3">
 	<td width="140px" align="center" class="txt">Financial Year</td>
   	<td width="140px" align="center" class="txt">ES filed date</td>
 	<td width="140px" align="center" class="txt">Remarks</td>
 ...
 <input name="financialYear" type="text" maxlength="15" size="50" class="txt4" />
</span>	
</td>
 <td bgcolor="#E8F6F9"><span class="txt style6">
 <input name="appId" type="hidden" value="<%=appDetId%>" />
 <input type="hidden" name="page" value="${page}"/> 
                        <calendar:datePicker name="esFiledDate" years="1900,2500" dateFormat="%d/%m/%Y" style="Size=12" defaultValue="${new Date()}" class="txt4"/>
                        <br><span class="sidetxt">(select date)</span></span></td>
                        
<td bgcolor="#E8F6F9"><span class="txt style6">
<input name="remarks" type="text" maxlength="50" size="50" class="txt4" />
...
<g:renderErrors bean="${unitMasterInstance}" as="list" />
 ...
 // frmvalidator.addValidation("esFiledDate","req","Please enter ES filed date");
...
<tr>
<td align="left"> 
<span class="txt" style="color: navy"><b>List of Environmental Statement Details added.</b></span>
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 	...
 	<td width="150px" align="center" class="txt">Financial Year</td>
   	<td width="150px" align="center" class="txt">ES filed date</td>
 	<td width="150px" align="center" class="txt">Remarks</td>
 
                      </tr>
 <g:each in="${environmentalStatementDetailsList}" status="i" var="environmentalStatementDetailsInst">
  <tr align="center" >
  
   <td bgcolor="#E8F6F9"><span class="txt style6">${environmentalStatementDetailsInst.financialYear}
                        </span></td>
                         
  <td bgcolor="#E8F6F9"><span class="txt style6">${environmentalStatementDetailsInst.esFiledDate}
                        </span></td>
  <td bgcolor="#E8F6F9"><span class="txt style6">${environmentalStatementDetailsInst.remarks}
                        </span></td>
