...
<g:javascript library="prototype" />
  ...
  <g:form name="editWaterSolidDispos" method="post" action="editHotelWasteEmissionMaster" >
 <table align="center">
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                            <tr>
                              ...
                              <td width="420" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">Hotel Waste Generation and Emission Detail</a></td>
 					...
 					<tr bgcolor="#A8DAF3">
                        ...
                        <td width="150px" class="headngblue" ><div  class="style3">Type</div></td>
                                   <td width="150px" class="headngblue" ><div  class="style3">Quantiy</div></td>
                                    <td width="150px" class="headngblue" ><div  class="style3">Nature</div></td>
                                    <td width="150px" class="headngblue" ><div  class="style3">Method of Disposal/Treatment</div></td>
 ...
 <g:each in="${hotelWasteEmissionList}" status="i" var="hotelWasteEmissionInst">
  <tr align="center" >
  					...
  					<td bgcolor="#E8F6F9"><span class="txt style6">${hotelWasteEmissionInst.tmethod} </span></td>
  					 <td bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=hotelWasteEmissionInst.id%>"/>
                        </span></td>
