...
<g:javascript library="prototype" />
  ...
  <g:form name="AirStackEdit" method="post" action="deleteAirFlueEmmisionMaster" >
 <table align="center">
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        <td width="10%" class="headngblue" ><div  class="style3">Stack Attached To Plant</div></td>
                        <td width="15%" class="headngblue" ><div  class="style3">Fuel Name</div></td>
                        <td width="10%" class="headngblue" ><div  class="style3">Fuel Consumption Quantity</div></td>
                        ...
                        <td width="8%" class="headngblue" ><div  class="style3">Sulphur Content %</div></td>
                      	...
                      	<td width="7%" class="headngblue" ><div  class="style3">Delete</div></td>
  					...
  					<td  bgcolor="#E8F6F9"><span class="txt style6">${flueInst.stack}
                        ...
                        <td bgcolor="#E8F6F9"><span class="txt style6">${flueInst.sulphurCon}
                         ...
                         <%}%>
                          ...
                          <td  bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=flueInst.id%>"/>
                        </span></td>
