...
<body>
<g:form name="saveWaterWasteDischrgeDetail" method="post" action="saveWaterConsumptionDetailMaster" >
...
<tr bgcolor="#D1D1D1">
			...
			<tr><td>
				<table width="90%"  border="0" cellpadding="1" cellspacing="1" class="tblbdr">
					<tr bgcolor="#A8DAF3">
					<td width="20%" align="center" valign="middle"  class="headngblue">Water Consumtion Supply</td>
					
						<td width="20%" align="center" valign="middle"  class="headngblue">Quantity </td>
						
						<td width="20%" align="center" valign="middle"  class="headngblue">Storage Facility</td>
					</tr>
					<tr>
	...
	<g:select  from="${WaterUsageDetailMaster.list()}" name="waterConsumptionType" class="txt4" ></g:select>
						...
						<td bgcolor="#E8F6F9" align="center" class="headngblue">
							<input name="quantity" type="text" size="15" maxlength="50" class="txt4" /><br><span class="sidetxt">(KLD)</span>
						</td>
						
						
						<td bgcolor="#E8F6F9" align="center" class="headngblue">
							<input name="storageFacility" type="text" size="15" maxlength="50" class="txt4" />
						</td>
					
										</tr>
					<tr>
					<td colspan="2" align="center"><span style="color:red">*Please enter NA where nothing is applicable</span></br><input type="submit" name="Add" value="Add" class="actionbutton"></td>
					</tr>
				...
				<tr align="left">
				<td align="left"><span class="txt" style="color: navy"><b>List of Water Consumtion Details added.</b></span>
				<!--  -->
 ...
 <table width="90%"  border="0" align="left" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        <td width="150px" class="headngblue" ><div  class="style3">Water Consumtion details</div></td>
                        <td width="150px" class="headngblue" ><div  class="style3">Quantity</div></td>
                         <td width="150px" class="headngblue" ><div  class="style3">Storage Facility</div></td>
                      </tr>
 
 <g:each in="${waterConsumptionDetailList}" status="i" var="waterWasteDischargeList">
  <tr align="center" >
  					<td bgcolor="#E8F6F9"><span class="txt style6">${waterWasteDischargeList.waterConsumptionType}
                        </span></td>
                        <td bgcolor="#E8F6F9"><span class="txt style6">${waterWasteDischargeList.quantity}
                        </span></td>
                         <td bgcolor="#E8F6F9"><span class="txt style6">${waterWasteDischargeList.storageFacility}
                        </span></td>
