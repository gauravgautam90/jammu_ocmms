...
<body>
<g:form name="waterSourceModeUses" method="post" action="saveAirFlueEmmisionMaster" >
					...
					<td>
						...
						<tr class="headngblue" bgcolor="#A8DAF3">
							...
							<% 
								...
								def stackList = AirStackDetailsMaster.findAllByApplication(app1)
								def pollCtrlMeasr
								def ctrlEquip
								for(int i=0;i<stackList.size();i++){
									def stackId =  stackList.get(i)   	
									 ctrlEquip = AirStackPollutionCntrlDetailsMaster.findAllWhere(stack:stackId)
