...
<g:javascript library="prototype" />
  ...
  <g:form name="AirMiscDetailEdit" method="post" action="deleteAirMiscDetailMaster" >
 <table align="center">
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        <td width="30%" class="headngblue" ><div  class="style3">Release Of Odoriferous Compounds</div></td>
                        <td width="30%" class="headngblue" ><div  class="style3">Do You Have Adequate Facility For Collection Of Samples Of Emmisions In The Form Of Port Holes, Platforms, Ladder, etc.</div></td>
                        <td width="30%" class="headngblue" ><div  class="style3">Quality Of Flue Gas/Process Emissions</div></td>
  ...
  <tr align="center" >
  					<td bgcolor="#E8F6F9" ><span class="txt ">${miscInst.odorCompounds}
                        ...
                        <td bgcolor="#E8F6F9"><span class="txt ">${miscInst.quality}
                          ...
                          <td  bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=miscInst.id%>"/>
                        </span></td>
