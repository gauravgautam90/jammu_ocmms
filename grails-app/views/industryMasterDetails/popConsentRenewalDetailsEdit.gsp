...
<body>
<g:form name="waterSourceUses" method="post" action="deleteConsentRenewalDetails" >
<table align="center">
  ...
  <td bgcolor="#E8F6F9"><span class="txt style6">${consentRenewalDetailsInst.status}
  			...
  			<td bgcolor="#E8F6F9"><span class="txt style6">
				...
				<%}%>
                           ...
                           <td ><span class="txt style6"><input type="checkbox" name="delete" value="<%=consentRenewalDetailsInst.id%>" />
                        </span></td>    
    </tr>	
 </g:each>	
