...
<body>
<g:form name="waterSourceUses" method="post" action="saveOfficerDesignation" >
<div align="center">
...
<tr bgcolor="#D1D1D1">
			...
			<tr><td>
				<table class="tblbdr" width="100%"  border="0" >
					...
					<input type="hidden" name="appId" value="<%=appDetId%>">
						<td width="20%" align="center" valign="middle"  class="headngblue">Officer<span style="color:red">*</span></td>
						<td width="20%" align="center" valign="middle"  class="headngblue">Designation<span style="color:red">*</span></td> 
					</tr>
					
					<tr>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="officerName" type="text" size="15"class="txt4" />
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="designation" type="text" size="15"class="txt4" />						
		...
		<td colspan="5" align="center"><input type="submit" name="Add" value="Add" class="actionbutton"></td>
				...
				<tr>
				<td align="center"><span class="txt" style="color: navy"><b>Visiting Officer Details.</b></span>
