...
<g:form name="waterSourceModeUses" method="post" action="saveDeeRecommendationsBMWFresh" enctype="multipart/form-data">
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
			
				<% 
				def inspReport = WasteManagementFile.find("from WasteManagementFile afd where afd.applicationId=? and afd.typeOfFile='Inspection Report BMW'",[appId.id])
				%>
				...
				<tr>							  
				 ...
				 <td  width="65%" align="left" bgcolor="#E8F6F9" class="headngblue" colSpan=3> ${appId?.industryRegMasterObj?.indName},${appId?.industryRegMasterObj?.indAddress},${appId?.industryRegMasterObj?.indPin}</td>
				</tr> 
				...
				<%if(params?.type=="DEE"){%>
				<textarea rows="5" cols="45" name="deeRecommendations" class="txt4" id = "deeRecommendations" >${consentInspectionReportInst?.officerRemark}</textarea>
				<%}else{%>
				...
				<tr><td align="center" valign="middle" bgcolor="#A8DAF3" class="headngblue">Name </td>
<td  			align="center" bgcolor="#E8F6F9"  class="headngblue">
				<input type="text" name="officerName" id="officerName" value="${consentInspectionReportInst?.officerName}"/>
		</td
  </tr>
			<tr><td align="center" valign="middle" bgcolor="#A8DAF3" class="headngblue">Designation </td>
		<td  align="center" bgcolor="#E8F6F9"  class="headngblue"><input type="text" name="officerDesignation" id="officerDesignation" value="${consentInspectionReportInst?.officerDesignation}"/>
				</td
		  </tr>	
