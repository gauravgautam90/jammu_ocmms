...
<body>
<g:form name="waterSourceUses" method="post" action="saveHWMsafetyIns" >
<div align="center">
<table cellpadding="1" cellspacing="1" width="90%" class="tblbdr">
<tr bgcolor="#D1D1D1">
		<td   align="center" valign="middle"  class="headngblue">officer designation </td>
		</tr> 
			...
			<tr><td>
				<table class="tblbdr" width="100%"  border="0" >
					...
					<tr>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="safetyfacility" type="text" size="15"class="txt4" /></td>
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
 					    ...
 					    <td width="20%" align="center" valign="middle"  class="headngblue">Safety Facility</td>
