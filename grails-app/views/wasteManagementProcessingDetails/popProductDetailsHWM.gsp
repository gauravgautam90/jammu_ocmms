...
<body>
<g:form name="waterSourceUses" method="post" action="saveProductInspect" >
<div align="center">
<table cellpadding="1" cellspacing="1" width="90%" class="tblbdr">
<tr bgcolor="#D1D1D1">
		<td   align="center" valign="middle"  class="headngblue">Production in MT or KL/day</td>
		</tr> 
			...
			<tr><td>
				<table class="tblbdr" width="100%"  border="0" >
					...
					<input type="hidden" name="appId" value="<%=appDetId%>">
						<td width="20%" align="center" valign="middle"  class="headngblue">Product<span style="color:red">*</span></td>
						<td width="20%" align="center" valign="middle"  class="headngblue">Quantity<span style="color:red">*</span></td> 
						<td width="20%" align="center" valign="middle"  class="headngblue">Quantity Unit<span style="color:red">*</span></td> 
						<td width="20%" align="center" valign="middle"  class="headngblue">Status Unit<span style="color:red">*</span></td> 
					</tr>
					
					<tr>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="product" type="text" size="15"class="txt4" /></td>
					...
					<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="status" type="text" size="15"class="txt4" />	</td>
					</tr>
		...
		<td colspan="5" align="center"><input type="submit" name="Add" value="Add" class="actionbutton"></td>
				...
				<tr>
				<td align="center"><span class="txt" style="color: navy"><b>Production in MT or KL/day.</b></span>
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
						...
						<td width="20%" align="center" valign="middle"  class="headngblue">Product</td>
						<td width="20%" align="center" valign="middle"  class="headngblue">Quantity</td>
						<td width="40%" align="center" valign="middle"  class="headngblue">Status</td>
					</tr>
