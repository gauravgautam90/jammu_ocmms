...
<body>
<g:form name="waterSourceUses" method="post" action="deleteHWMActualUserAuth" >
<div align="center">
<table cellpadding="1" cellspacing="1" width="90%" class="tblbdr">
<tr bgcolor="#D1D1D1">
		<td   align="center" valign="middle"  class="headngblue"> </td>
		</tr> 
			...
			<tr><td>
				...
				<tr>
				<td align="center"><span class="txt" style="color: navy"><b>Fuel Consumption Details added.</b></span>
