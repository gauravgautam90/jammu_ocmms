...
<body>
<g:form name="waterSourceUses" method="post" action="saveHwmStorageInspection" >
<div align="center">
			...
			<tr><td>
				<table class="tblbdr" width="100%"  border="0" >
					...
					<input type="hidden" name="appId" value="<%=appDetId%>">
						<td width="20%" align="center" valign="middle"  class="headngblue">Name and Category HWM<span style="color:red">*</span></td>
						<td width="20%" align="center" valign="middle"  class="headngblue">Actual HW generated(in Tonne)<span style="color:red">*</span></td> 
						<td width="20%" align="center" valign="middle"  class="headngblue">Previous Stock(in Tonne) stored in storage shed(at the beginning of prev financial year)<span style="color:red">*</span></td> 
						<td width="20%" align="center" valign="middle"  class="headngblue">Actual Quantity(in tonne) found stored on the day of inspection<span style="color:red">*</span></td> 
						<td width="20%" align="center" valign="middle"  class="headngblue">Balance(in Tonne)<span style="color:red">*</span></td> 
						<td width="20%" align="center" valign="middle"  class="headngblue">Latest date of transfer of HW to authorized recyler/Co-processor<span style="color:red">*</span></td> 
					</tr>
					
					<tr>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="hmwNameAndCategory" type="text" size="15"class="txt4" /></td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="quantityHWM" type="text" size="15"class="txt4" />	</td>					
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="prevStockQuan" type="text" size="15"class="txt4" />	</td>					
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="actualQuant" type="text" size="15"class="txt4" />	</td>
					<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="balance" type="text" size="15"class="txt4" />		</td>
					<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="datetransfer" type="text" size="15"class="txt4" />		</td>
					</tr>
