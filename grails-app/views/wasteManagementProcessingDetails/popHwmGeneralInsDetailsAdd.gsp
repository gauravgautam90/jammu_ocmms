...
<body>
<g:form name="waterSourceUses" method="post" action="saveHwmGeneralInspection" >
<div align="center">
		...
		<td   align="center" valign="middle"  class="headngblue">Name and Categories of HWM generated and their respective quantity</td>
			...
			<tr><td>
				<table class="tblbdr" width="100%"  border="0" >
					...
					<tr>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="productionPlant" type="text" size="15"class="txt4" /></td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="hmwName" type="text" size="15"class="txt4" />	</td>					
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="quantityHWMGen" type="text" size="15"class="txt4" />	</td>					
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="quantityConsentedCap" type="text" size="15"class="txt4" />	</td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="production1" type="text" size="15"class="txt4" />	</td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="input1" type="text" size="15"class="txt4" />	</td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="production2" type="text" size="15"class="txt4" />	</td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="input2" type="text" size="15"class="txt4" />	</td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="quantityCurrentFinYear" type="text" size="15"class="txt4" />	</td>
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="quantityPrevFinYear" type="text" size="15"class="txt4" />	</td>
