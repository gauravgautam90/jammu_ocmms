...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                <input type="hidden" name="id" value="${cessReturnInstance?.id}" />
                <input type="hidden" name="version" value="${cessReturnInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
