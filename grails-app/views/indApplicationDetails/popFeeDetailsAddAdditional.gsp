...
selectmenu1.onchange=function()
 {    
  ...
  <body>
  <g:form  method="post" action="saveBankFeeDetailsAdditional" name="myForm">
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
  ...
  <td><div style="width: 500px;  vertical-align: middle"><span
 					...
 					<g:form  method="post" action="saveChequeAttachAdditional" name="myForm1" enctype="multipart/form-data">
...
<%}%></td>
 					...
 					<td class="txt style6" align="left" colspan="3"><%if(feeChequeAdditional){%>	<g:def var="fooVar" value="${appDetId}"/><g:link action="viewChequeAttached" controller="indApplicationDetails" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
 					<%}%></td>
 					</tr>
