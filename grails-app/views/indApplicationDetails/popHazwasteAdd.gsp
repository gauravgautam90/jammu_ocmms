...
<body>
<g:form name="waterSourceUses" method="post" action="saveHazwastedetails" >
		...
		<td   align="center" valign="middle"  class="headngblue">Hazardous waste is being produced </td>
			...
			<table class="tblbdr" width="100%"  border="0" >
					...
					<input type="hidden" name="app8" value="<%=appDetId%>">
						<td width="20%" align="center" valign="middle"  class="headngblue">  Name of hazardous waste <span style="color:red">*</span></td>
