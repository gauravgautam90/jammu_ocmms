...
<script type="text/javascript" language="javascript">window.history.forward(1);</script>
  ...
  <g:form name="AirStackEdit" method="post" action="editSolidwastedetails" >
 <table align="center">
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
					...
					<td width="20%" align="center" valign="middle"  class="headngblue"> Method of Disposal </td>
    				  ...
    				  <tr align="center" >
                           ...
                           <td  bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=Solidwastedetails.id%>"/>
  ...
  <tr>
   ...
   <td align="center"><input type="hidden" name="app" value="<%=appDetId%>"/><input type="submit" name="Delete" value="Delete" class="actionbutton"></td>
