...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        ...
                        <td width="150px"  valign="middle" class="headngblue"><div  class="style3">Quantity(KL/D)</div></td>
                        <td ><div ><span class="txt style6">${sourceInstance.quantity}</span></div></td>
                      </tr>
 
  <tr align="center" >
  					<td width="150px" class="headngblue" ><div class="style3">Use</div></td>
                    <td width="150px"  valign="middle" class="headngblue"><div  class="style3">Quantity Used(KL/D)</div></td>				
        			...
        			<tr bgcolor="#F4F7FB">
                      <td align="center"><span class="txt style6"><%=(usesList.get(j)).use %>
                        </span></td>
                       <td ><div align="center"><span class="txt style6"><%=(usesList.get(j)).quantity %></span></div></td>
                      </tr>
                      
        <%} %>
        
        <tr align="center" >
  					<td width="150px" class="headngblue" ><div  class="style3">Mode of Use</div></td>
                    <td width="150px"  valign="middle" class="headngblue"><div  class="style3">Quantity(KL/D)</div></td>				
                    <td width="150px" class="headngblue" ><div  class="style3">Waste Water Generated</div></td>          
        </tr>
        <%for(int j=0;j<modeUseList.size();j++){ %>
        			<tr bgcolor="#F4F7FB">
                      <td align="center"><span class="txt style6"><%=(modeUseList.get(j)).modeUse %>
                        </span></td>
                       <td ><div align="center"><span class="txt style6"><%=(modeUseList.get(j)).quantity %></span></div></td>
                       <td ><div align="center"><span class="txt style6"><%=(modeUseList.get(j)).wasteWaterGenerated %></span></div></td>
                      </tr>
