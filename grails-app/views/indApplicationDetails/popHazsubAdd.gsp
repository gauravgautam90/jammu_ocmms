...
<body>
<g:form name="waterSourceUses" method="post" action="saveHazsubdetails" >
		...
		<td   align="center" valign="middle"  class="headngblue">Hazardous substances used </td>
			...
			<table class="tblbdr" width="100%"  border="0" >
					...
					<input type="hidden" name="app8" value="<%=appDetId%>">
						<td width="20%" align="center" valign="middle"  class="headngblue"> Name of substances <span style="color:red">*</span></td>
