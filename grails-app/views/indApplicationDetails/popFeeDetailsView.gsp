...
<%}%></td>
 					...
 					<tr bgcolor="#F4F7FB" >
 					<td class="txt style6" align="right" colspan="3">Scaned Copy of Additional Drafts/Cheques &nbsp;: </td>
 					<td class="txt style6" align="left" colspan="3"><%if(feeChequeAdditional){%>	<g:def var="fooVar" value="${appDetId}"/><g:link action="viewChequeAttachedAdditional" controller="indApplicationDetails" params="[appliLoc:fooVar]"><span class="innerlink"><u>Download</u></span></g:link>
 					<%}%></td>
 					</tr>
...
<tr>
    ...
    <td align="center" height="1" colspan="2" bgcolor="#d0d1d0"><input type="button" class="actionbutton" name="back" value="Back" onclick="window.open('<%=request.getContextPath()%>/indApplicationDetails/doGetShowPop/<%=appDetId%>#country3', 'ApplicationHistory', 'WIDTH=800,HEIGHT=450,scrollbars=1,resizable=yes');"></td>
