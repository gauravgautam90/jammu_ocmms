...
<script type="text/javascript" language="javascript">window.history.forward(1);</script>
  ...
  <g:form name="AirStackEdit" method="post" action="editHazwastedetails" >
 <table align="center">
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
                            <tr>
                              ...
                              <td width="420" align="center" background="${createLinkTo(dir:'images2/gif',file:'industry_details_middle.gif')}" class="top-lnks"><a href="#" rel="country1">Hazardous waste is being produced</a></td>
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
 					<td width="20%" align="center" valign="middle"  class="headngblue"> Name of hazardous waste</td>
					<td width="20%" align="center" valign="middle"  class="headngblue">Quantity </td>
                      ...
                      <g:each in="${Hazwastedetails}" status="i" var="Hazwastedetails">
    				  <tr align="center" >
    				  					    
    				                        <td bgcolor="#E8F6F9"><span class="txt style6">
    				                        ${Hazwastedetails.name}</span></td>
    				                        <td bgcolor="#E8F6F9"><span class="txt style6">
    				                        ${Hazwastedetails.quantity}</span></td>
    				                       
                      	
   
                         
                           <td  bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=Hazwastedetails.id%>"/>
