...
<body>
<g:form name="waterSolidWasteGen" method="post" action="saveWaterUsageDetail" >
...
<tr bgcolor="#D1D1D1">
			<td   align="center" valign="middle"  class="headngblue">Water Usage Details</td>
		</tr> 
				
			<tr><td>
				<table width="90%"  border="0" cellpadding="1" cellspacing="1" class="tblbdr">
					<tr bgcolor="#A8DAF3">
					<td width="20%" align="center" valign="middle"  class="headngblue">Usage Details</td>
	...
	<g:select  from="${WaterUsageDetailMaster.list()}" name="description" class="txt4" ></g:select>
				...
				<tr align="left">
				<td align="left"><span class="txt" style="color: navy"><b>List of Water Usage Details added.</b></span>
				<!--  -->
 ...
 <table width="90%"  border="0" align="left" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        <td width="20%" class="headngblue" ><div  class="style3">Usage Details</div></td>
                        <td width="20%" class="headngblue" ><div  class="style3">Quantity (KLD)</div></td>
                        
                      </tr>
 
 <g:each in="${waterUsageDetailList}" status="i" var="waterUsageDetailList">
  <tr align="center" >
  					<td bgcolor="#E8F6F9"><span class="txt style6">${waterUsageDetailList.description}
                        </span></td>
                        <td bgcolor="#E8F6F9"><span class="txt style6">${waterUsageDetailList.quantQual}
                        </span></td>
