...
<g:javascript library="prototype" />
  ...
  <g:form name="AirStackEdit" method="post" action="editAirFugitiveEmmission">
 <table align="center">
 ...
 <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        <td width="150px" class="headngblue" ><div  class="style3">Stack Attached To Plant</div></td>
                      	...
                      	<td width="150px" class="headngblue" ><div  class="style3">Pollution Control Eqipments</div></td>
                      	<td width="150px" class="headngblue" ><div  class="style3">Delete</div></td>
                      </tr>
 <g:each in="${airStackInstList}" status="i" var="stackDetInst">
  <tr align="center" >
  					<td align="left" bgcolor="#E8F6F9"><span class="txt style6">${stackDetInst.stack}
                        </span></td>
