...
<body>
<g:form name="waterSourceUses" method="post" action="savesoliddetails" >
		...
		<td   align="center" valign="middle"  class="headngblue">Mode of Storage </td>
			...
			<table class="tblbdr" width="100%"  border="0" >
					...
					<input type="hidden" name="app8" value="<%=appDetId%>">
						<td width="20%" align="center" valign="middle"  class="headngblue">Name of the Hazardous Waste generated/to be generated<span style="color:red">*</span></td>
						<td width="20%" align="center" valign="middle"  class="headngblue">Catogary of Hazardous Waste <span style="color:red">*</span></td>
						<td width="20%" align="center" valign="middle"  class="headngblue">Size of the Room/shed(in mts.)<span style="color:red">*</span></td>
						<td width="20%" align="center" valign="middle"  class="headngblue">Storage Capacity(in terms of months)<span style="color:red">*</span></td>
					...
					<tr>
						...
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="category" type="text" maxlength="10" size="15"class="txt4" />
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="roomsize" type="text" size="15" class="txt4" />
						<td bgcolor="#E8F6F9" align="center" class="headngblue"><input name="storage" type="text" size="15" class="txt4" />
