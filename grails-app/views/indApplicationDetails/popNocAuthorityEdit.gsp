...
<g:javascript library="prototype" />
  ...
  <body>
  <g:form name="editHazardousChemical" method="post" action="editNocAuthorityDetail" >
 <table align="center">
<tr align="center">
...
<g:each in="${nocAuthorityDetailsInst}" status="i" var="nocAuthorityDetailsInst">
  <tr align="center" >
  					...
  					<td bgcolor="#E8F6F9"><span class="txt style6">${nocAuthorityDetailsInst.date} </span></td>
                        ...
                        <td  bgcolor="#E8F6F9"><span class="txt style6"><input type="checkbox" name="delete" value="<%=nocAuthorityDetailsInst.id%>"/>
                        </span></td>
        </tr>		
      </g:each>		
