...
<g:javascript library="prototype" />
  ...
  <body>
  <g:form name="editHazardousChemical" method="post" action="editMiscellaneous" >
 <table align="center">
<tr align="center">
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
 					...
 					<tr bgcolor="#A8DAF3">
                        <td width="12%" class="headngblue" ><div  class="style3">Pollution Control Equipments(For Water pollution control</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Total Cost on pollution control</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Is DG Set installed</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">D.G Set capacity</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Acostic enclosure</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Noise Pollution</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Measure to contain noise pollution taken</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Prescribed parameters achieved for noise</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Hazardeous Substance Used</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Name of the substance</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Quantity</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Hazardeous waste being produced</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">Name of hazardeous waste</div></td>
                         <td width="12%" class="headngblue" ><div  class="style3">quantity</div></td>
