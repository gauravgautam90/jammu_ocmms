...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblbdr" >
				...
				<!--
				<tr>
				<td width="50%" align="left" valign="middle" bgcolor="#A8DAF3" class="headngblue">CIN No.</td>
					<td  align="left" bgcolor="#E8F6F9"  class="headngblue"><span class="txt4 ">
					${cinVal}</span></td>
				</tr>
				-->
...
<tr>
 ...
 <tr>
    ...
    <td align="center" height="1" colspan="2" bgcolor="#d0d1d0"><input type="button" class="actionbutton" name="back" value="Back" onclick="window.open('<%=request.getContextPath()%>/applicationProcessingDetails/openApplicationDetails/<%=appDetId%>#country3', 'ApplicationHistory', 'WIDTH=600,HEIGHT=300,scrollbars=1,resizable=yes');" ></td>
