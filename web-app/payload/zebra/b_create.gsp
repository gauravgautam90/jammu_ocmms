        ...
        <tr align="left">
          <td colspan="2" ><table width="110" border="0" cellspacing="0" cellpadding="0">
                          <tr >
                            ...
                            <td bgcolor="#5A89D9" class="headng1" width="134">Add Office</td>
                      ...
                      <tr align="center" >
                              <td width="150px" align="right" valign="middle" class="headngblue">Office Name :</td>
                        <td align="left" class="value ${hasErrors(bean:officeMasterInstance,field:'officeName','errors')} txt4">
                                    <input type="text" id="officeName" name="officeName" value="${fieldValue(bean:officeMasterInstance,field:'officeName')}"/>
                                </td>
                        </div></td>
                      </tr>
                            <tr align="center" >
                              <td width="150px" align="right" valign="middle" class="headngblue"><div align="right" class="style3">Enter District :</div></td>
                        <td valign="top" class="value ${hasErrors(bean:officeMasterInstance,field:'priority','errors')}">
                       <select name="priority"  class="txt4">
